...
Public Class ClsPrinting
    ...
    Public Sub Generate_Report(ByVal mQry As String, ByRef mConn As SqliteConnection, ByRef mCRD As ReportDocument,
                                ByRef mRepView As RepView, ByVal mReportPath As String, ByVal mRepName As String, ByVal mRepTitle As String,
