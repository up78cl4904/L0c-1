...
Public Class ClsIniVariables
    ...
    Public Sub FOpenCompanyConnection()
        ...
        Agl.GcnMain_ConnectionString = "Data Source=" & Agl.PubCompanyDBName & ";Version=3;"
        Agl.GcnMain.ConnectionString = "Data Source=" & Agl.PubCompanyDBName & ";Version=3;"
        Agl.ECompConn_ConnectionString = "Data Source=" & Agl.PubCompanyDBName & ";Version=3;"
        Agl.ECompConn.ConnectionString = "Data Source=" & Agl.PubCompanyDBName & ";Version=3;"
    ...
    Public Sub FOpenConnection(ByVal StrCompanyCode As String, Optional ByVal StrSiteCode As String = "", Optional ByVal CheckKiller As Boolean = True)
        ...
        Try
            ...
            If DTTemp.Rows.Count > 0 Then
                ...
                Agl.Gcn_ConnectionString = "Data Source=" & Agl.PubDBName & ";Version=3;"
                Agl.GCn.ConnectionString = Agl.Gcn_ConnectionString
                Agl.GcnRead.ConnectionString = "Data Source=" & Agl.PubDBName & ";Version=3;"

                Agl.GCnRep_ConnectionString = "Data Source=" & Agl.PubDBName & ";Version=3;"
                Agl.GCnRep.ConnectionString = Agl.GCnRep_ConnectionString
            ...
            With DsComp.Tables(0)
                If .Rows.Count > 0 Then
                    For I = 0 To .Rows.Count - 1
                        ...
                        End If
                        mQRY = "Create View [" & mTable_Name & "] As " &
