...
Public Class FrmPaymentDetail
    ...
    Sub Ini_List()
        ...
        Try
            ...
            mQry = "Select Sg.SubCode As Code, Sg.Name As [A/c Name], Sg.Nature " &
                    " From SubGroup Sg  " &
                    " Where Sg.Nature ='Cash' And " & AgL.PubSiteConditionCommonAc(AgL.PubIsHo, "Sg.Site_Code", AgL.PubSiteCode, "Sg.CommonAc") & " " &
                    " Order By Sg.Name"
    ...
    Private Sub IniBankNameHelp()
        Try
            mQry = "SELECT B.Bank_Code AS Code, B.Bank_Name AS Name, " &
                    " Case When IfNull(IsActive,0) <> 0 Then 'Yes' Else 'No' End As IsActive " &
                    " FROM Bank B  " &
    ...
    Private Sub Control_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles _
        TxtCashAc.Enter, TxtBank_Code.Enter, TxtChq_No.Enter, TxtChq_Date.Enter,
    ...
    Private Sub Control_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles _
      TxtCashAmount.Validating, TxtCashAc.Validating, TxtBankAmount.Validating, TxtBank_Code.Validating, TxtChq_No.Validating, TxtChq_Date.Validating,
      TxtBankAc.Validating, TxtAcTransferBankAc.Validating, TxtAcTransferBank_Code.Validating, TxtAcTransferAcNo.Validating, TxtAcTransferAmount.Validating,
      TxtCardAc.Validating, TxtCard_No.Validating, TxtCardAmount.Validating, TxtCardBank_Code.Validating, TxtClg_Date.Validating,
      TxtBankAc2.Validating, TxtBankAmount2.Validating, TxtChq_No2.Validating, TxtChq_Date2.Validating, TxtClg_Date2.Validating, TxtBank_Code2.Validating,
      TxtBankAc3.Validating, TxtBankAmount3.Validating, TxtChq_No3.Validating, TxtChq_Date3.Validating, TxtClg_Date3.Validating, TxtBank_Code3.Validating,
    ...
    Private Sub Calculation()
        ...
        bTotal = Val(TxtCashAmount.Text) + Val(TxtBankAmount.Text) + Val(TxtBankAmount2.Text) +
                    Val(TxtBankAmount3.Text) + Val(TxtCardAmount.Text) + Val(TxtAcTransferAmount.Text) +
                    Val(TxtAdjustmentAmount.Text)

        TxtTotalPayment.Text = Format(bTotal, "0.00")
    End Sub

    Public Function DeletePaymentDetail(ByVal mConn As SQLiteConnection, ByVal mCmd As SQLiteCommand) As Boolean
        Try
    ...
    Public Function SavePaymentDetail(ByRef PaymentRec As AgLibrary.ClsMain.PaymentDetail, ByVal mConn As SQLiteConnection, ByVal mCmd As SQLiteCommand) As Boolean
        ...
        Try
            ...
            If Val(PaymentRec.TotalAmount) > 0 Then
                mQry = "INSERT INTO PaymentDetail ( DocId, CashAc, CashAmount, BankAc, BankAmount, Bank_Code, Chq_No, " &
                        " Chq_Date, Clg_Date, CardAc, CardAmount, CardBank_Code, Card_No, AcTransferBankAc, AcTransferAmount," &
                        " AcTransferBank_Code, AcTransferAcNo, TotalAmount, PartyDrCr, " &
                        " BankAc2, BankAmount2, Bank_Code2, Chq_No2, Chq_Date2, Clg_Date2, " &
                        " BankAc3, BankAmount3, Bank_Code3, Chq_No3, Chq_Date3, Clg_Date3, " &
                        " AdjustmentAc, AdjustmentAmount, AdjustmentRemark) VALUES  ( " &
                        " " & AgL.Chk_Text(mSearchCode) & ", " & AgL.Chk_Text(PaymentRec.CashAc) & ", " & Val(PaymentRec.CashAmount) & "," &
                        " " & AgL.Chk_Text(PaymentRec.BankAc) & ", " & Val(PaymentRec.BankAmount) & ", " & AgL.Chk_Text(PaymentRec.Bank_Code) & "," &
                        " " & AgL.Chk_Text(PaymentRec.Chq_No) & ", " & AgL.ConvertDate(PaymentRec.Chq_Date) & ", " & AgL.ConvertDate(PaymentRec.Clg_Date) & "," &
                        " " & AgL.Chk_Text(PaymentRec.CardAc) & ", " & Val(PaymentRec.CardAmount) & ", " & AgL.Chk_Text(PaymentRec.CardBank_Code) & ", " & AgL.Chk_Text(PaymentRec.Card_No) & "," &
                        " " & AgL.Chk_Text(PaymentRec.AcTransferBankAc) & ", " & Val(PaymentRec.AcTransferAmount) & ", " & AgL.Chk_Text(PaymentRec.AcTransferBank_Code) & "," &
                        " " & AgL.Chk_Text(PaymentRec.AcTransferAcNo) & ", " & Val(PaymentRec.TotalAmount) & ", " & AgL.Chk_Text(PaymentRec.PartyDrCr) & ", " &
                        " " & AgL.Chk_Text(PaymentRec.BankAc2) & ", " & Val(PaymentRec.BankAmount2) & ", " & AgL.Chk_Text(PaymentRec.Bank_Code2) & "," &
                        " " & AgL.Chk_Text(PaymentRec.Chq_No2) & ", " & AgL.ConvertDate(PaymentRec.Chq_Date2) & ", " & AgL.ConvertDate(PaymentRec.Clg_Date2) & "," &
                        " " & AgL.Chk_Text(PaymentRec.BankAc3) & ", " & Val(PaymentRec.BankAmount3) & ", " & AgL.Chk_Text(PaymentRec.Bank_Code3) & "," &
                        " " & AgL.Chk_Text(PaymentRec.Chq_No3) & ", " & AgL.ConvertDate(PaymentRec.Chq_Date3) & ", " & AgL.ConvertDate(PaymentRec.Clg_Date3) & ", " &
                        " " & AgL.Chk_Text(PaymentRec.AdjustmentAc) & ", " & Val(PaymentRec.AdjustmentAmount) & ", " & AgL.Chk_Text(PaymentRec.AdjustmentRemark) & " " &
                        " )"
                AgL.Dman_ExecuteNonQry(mQry, mConn, mCmd)
            End If
    ...
    'Public Function AccountPosting(ByRef PaymentRec As AgLibrary.ClsMain.PaymentDetail, ByVal mConn As SqliteConnection, ByVal mConnectionString As String, ByVal mCmd As SqliteCommand, ByRef LedgAry() As AgLibrary.ClsMain.LedgRec, _
    ...
    '            mQry = "Select Bank_Name From Bank  Where Bank_Code = '" & PaymentRec.Bank_Code & "'"
    ...
    '            mQry = "Select Bank_Name From Bank  Where Bank_Code = '" & PaymentRec.Bank_Code2 & "'"
    '            mBankName = AgL.Dman_Execute(mQry, mConn, mCmd).ExecuteScalar()
    ...
    '            mQry = "Select Bank_Name From Bank  Where Bank_Code = '" & PaymentRec.Bank_Code3 & "'"
    '            mBankName = AgL.Dman_Execute(mQry, mConn, mCmd).ExecuteScalar()
    ...
    '            mQry = "Select Bank_Name From Bank  Where Bank_Code = '" & PaymentRec.CardBank_Code & "'"
    '            mBankName = AgL.Dman_Execute(mQry, mConn, mCmd).ExecuteScalar()
    ...
    '            mQry = "Select Bank_Name From Bank  Where Bank_Code = '" & PaymentRec.AcTransferBank_Code & "'"
    '            mBankName = AgL.Dman_Execute(mQry, mConn, mCmd).ExecuteScalar()
    ...
    Public Function AccountPosting(ByRef PaymentRec As AgLibrary.ClsMain.PaymentDetail, ByVal mConn As SQLiteConnection, ByVal mConnectionString As String, ByVal mCmd As SQLiteCommand, ByRef LedgAry() As AgLibrary.ClsMain.LedgRec,
                                        Optional ByVal mCommonNarr As String = "", Optional ByVal mPostTotalAmountYesNo As Boolean = True) As Boolean
        Dim I As Integer = 0
        Dim mNarr$ = "", mTransStr$ = "", mBankName$ = "", bContraSub$ = ""
        Dim mVNo As Long = Val(AgL.DeCodeDocID(mSearchCode, AgLibrary.ClsMain.DocIdPart.VoucherNo))
