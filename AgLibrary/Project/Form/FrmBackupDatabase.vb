...
Public Class FrmBackupDatase
    ...
    Public Function BackupDataBase(ByVal mConn As SqliteConnection, ByVal mCompConn As SqliteConnection,
                                   Optional ByVal mAgReportConn As SqliteConnection = Nothing,
                                   Optional ByVal mImageConn As SqliteConnection = Nothing) As Boolean
