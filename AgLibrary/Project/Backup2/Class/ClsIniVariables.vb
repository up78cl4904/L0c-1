    ...
    Private Function FIniUser(ByVal StrUserName As String, ByVal StrPassword As String) As Boolean
        ...
        Try
            ...
            If Agl.StrCmp(StrUserName, AgLibrary.ClsConstant.PubSuperUserName) Then
                ...
                End If
            Else
                DtTemp = Agl.FillData("Select U.* From UserMast U With (NoLock) Where U.User_Name='" & StrUserName & "'", Agl.ECompConn).TABLES(0)
                ...
                If UCase(StrPassword) = UCase(Agl.DCODIFY(StrGetPassword)) And (Not StrGetPassword Is Nothing) Then
                    ...
                    If Agl.IsFieldExist("IsActive", "UserMast", Agl.ECompConn) Then
                        Agl.PubIsUserActive = Agl.VNull(Agl.Dman_Execute("Select IsNull(U.IsActive,1) As IsUserActive From UserMast U  With (NoLock) Where U.User_Name='" & StrUserName & "'", Agl.ECompConn).ExecuteScalar)
                    End If
        ...
        Try
            ...
            If DTTemp.Rows.Count > 0 Then
                ...
                If Agl.XNull(Agl.PubImageDBName).ToString.Trim <> "" Then
                    Agl.GcnImage = New SqlClient.SqlConnection()
