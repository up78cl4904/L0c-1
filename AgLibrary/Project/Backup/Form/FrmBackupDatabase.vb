Public Class FrmBackupDatase
        ...
        Try
            Select Case sender.name
                Case BtnBackupDatabase.Name
                    ...
                    Call BackupDataBase(AgL.GCn, AgL.ECompConn, AgL.GCnRep)
    ...
    Public Function BackupDataBase(ByVal mConn As SqlClient.SqlConnection, ByVal mCompConn As SqlClient.SqlConnection, Optional ByVal mAgReportConn As SqlClient.SqlConnection = Nothing) As Boolean
