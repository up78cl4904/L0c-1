...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.LblSalesTaxPostingGroup.Size = New System.Drawing.Size(67, 16)
        Me.LblSalesTaxPostingGroup.TabIndex = 694
        Me.LblSalesTaxPostingGroup.Text = "Tax Group"
        '
        'TxtItemGroup
        '
        ...
        Me.TxtHSN.AgNumberLeftPlaces = 0
        ...
        Me.TxtHSN.Location = New System.Drawing.Point(334, 154)
        Me.TxtHSN.MaxLength = 20
        Me.TxtHSN.Name = "TxtHSN"
        Me.TxtHSN.Size = New System.Drawing.Size(129, 18)
        ...
        Me.LblVatCommodityCode.Size = New System.Drawing.Size(69, 16)
        Me.LblVatCommodityCode.TabIndex = 708
        Me.LblVatCommodityCode.Text = "HSN Code"
        '
        'TxtReorderLevel
        '
...
#End Region
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SQLiteConnection, ByVal Cmd As SQLiteCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = "UPDATE Item " &
                ...
                " MeasureUnit = " & AgL.Chk_Text(TxtUnit.Text) & ", " &
                " Rate = " & Val(TxtRate.Text) & ", " &
                " ItemGroup = " & AgL.Chk_Text(TxtItemGroup.AgSelectedValue) & ", " &
                " ItemCategory = " & AgL.Chk_Text(TxtItemCategory.Text) & ", " &
                " ItemType = " & AgL.Chk_Text(ClsMain.ItemType.FinishedMaterial) & ", " &
                " Manufacturer = " & AgL.Chk_Text(TxtManufacturer.AgSelectedValue) & ", " &
                " HSN = " & AgL.Chk_Text(TxtHSN.Text) & ", " &
                " ReorderLevel = " & Val(TxtReorderLevel.Text) & ", " &
                " ProfitMarginPer = " & Val(TxtProfitMarginPer.Text) & ", " &
    ...
    Private Sub FPostRateInRateList(ByVal Conn As SQLiteConnection, ByVal Cmd As SQLiteCommand)
        ...
        mQry = " INSERT INTO RateList(Code, WEF, RateType, EntryBy, EntryDate, EntryType, " &
                ...
                " VALUES (" & AgL.Chk_Text(bRateListCode) & ", " & AgL.Chk_Text(AgL.PubStartDate) & ",	" &
                " NULL,	'" & AgL.PubUserName & "', '" & AgL.PubLoginDate & "', " &
                " '" & Topctrl1.Mode & "', 'Open', '" & AgTemplate.ClsMain.EntryStatus.Active & "', " &
        ...
        mQry = "INSERT INTO RateListDetail(Code, Sr, WEF, Item, RateType, Rate) " &
              ...
              " 1, " & AgL.Chk_Text(AgL.PubStartDate) & ", " &
    ...
    Private Sub FrmQuality1_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        ...
        mQry = " SELECT H.Subcode Code, H.Name Description FROM Subgroup H "
    ...
    Private Sub FrmQuality1_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                TxtHSN.AgSelectedValue = AgL.XNull(.Rows(0)("VatCommodityCode"))
                ...
                TxtHSN.AgLastValueTag = TxtHSN.Tag
                TxtHSN.AgLastValueText = TxtHSN.Text
            End If
        End With
    End Sub
    ...
    Private Sub Control_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TxtDescription.Validating, TxtItemGroup.Validating, TxtHSN.Validating
    ...
    Private Sub FrmItem_BaseEvent_Topctrl_tbAdd() Handles Me.BaseEvent_Topctrl_tbAdd
        ...
        TxtHSN.Tag = TxtHSN.AgLastValueTag
    ...
    Private Sub BtnImprtFromExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnImprtFromExcel.Click
        ...
        For I = 0 To DtTemp.Rows.Count - 1
            ...
            TxtHSN.AgSelectedValue = AgL.XNull(AgL.PubDtEnviro.Rows(0)("DefaultVatCommodityCode"))
            TxtSalesTaxPostingGroup.AgSelectedValue = AgL.XNull(AgL.Dman_Execute(" Select SalesTaxPostingGroup From VatCommodityCode Where Code = '" & TxtHSN.AgSelectedValue & "'", AgL.GcnRead).ExecuteScalar)
