...
Public Class FrmPurchaseInvoiceHeader
    ...
    Public Sub FSave(ByVal SearchCode As String, ByVal Conn As SQLiteConnection, ByVal Cmd As SQLiteCommand)
        ...
        If Dgl1.Item(Col1Value, rowTransporter).Tag <> "" Or
           ...
           Dgl1.Item(Col1Value, rowLrPaymentType).Value <> "" Then


            mQry = "Insert Into PurchInvoiceTransport (DocID, Transporter, LRNo, LRDate, PrivateMark, Weight, Freight, PaymentType)
                Values ('" & SearchCode & "', 
