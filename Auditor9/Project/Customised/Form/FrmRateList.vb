...
#End Region
    ...
    Public Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        Dim mConStr$ = ""
        mConStr = "WHERE 1=1  "
        AgL.PubFindQry = "SELECT H.Code, H.WEF, Rt.Description As RateType " &
                        " FROM RateList H " &
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SQLiteConnection, ByVal Cmd As SQLiteCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = "UPDATE RateList " &
                " SET " &
                " WEF = " & AgL.Chk_Text(TxtWEF.Text) & ", " &
                " RateType = " & AgL.Chk_Text(TxtRateType.AgSelectedValue) & " " &
                ...
                If .Item(Col1Item, I).Value <> "" Then
                    If Val(.Item(Col1Rate, I).Value) <> Val(.Item(Col1PrevRate, I).Value) Then
                        ...
                        mQry = "INSERT INTO RateListDetail(Code, Sr, WEF, Item, RateType, Rate) " &
                               ...
                               " " & bSr & ", " & AgL.Chk_Text(TxtWEF.Text) & ", " &
                               " " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1Item, I)) & ", " &
                               " " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1RateType, I)) & ", " &
    ...
    Private Sub BtnFill_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnFill.Click
        Dim I As Integer = 0
        Try
            mQry = " SELECT I.Code AS SearchCode,I.Description," &
                            " I.EntryBy AS [Entry_By], I.EntryDate AS [Entry_Date], I.EntryType AS [Entry_Type], " &
                            " RD.Description AS Design, RS.Description AS Size  " &
                            " FROM Item I " &
                            " LEFT JOIN RUG_Design RD ON RD.Code = I.Design  " &
                            " LEFT JOIN Rug_Size RS ON RS.Code = I.Size  " &
            ...
            If FrmObj.DGL1.Rows.Count > 0 Then
                ...
                For I = 0 To FrmObj.DGL1.Rows.Count - 1
                    ...
                    If Val(TxtRate.Text) <> 0 Then
                        Dgl1.Item(Col1Rate, I).Value = TxtRate.Text
                    Else
                        mQry = " SELECT TOP 1 L.Rate FROM RateListDetail L WHERE L.Item = '" & Dgl1.AgSelectedValue(Col1Item, I) & "'  AND IfNull(L.RateType,'') = '" & Dgl1.AgSelectedValue(Col1RateType, I) & "'  ORDER BY L.WEF DESC "
