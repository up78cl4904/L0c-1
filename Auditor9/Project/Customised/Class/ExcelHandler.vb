...
Public Class ExcelHandler
    ...
    Public Function ExportToExcelMainForm(ByVal a_sData As DataSet, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String,
                                         ByVal xlObject As Excel.Application,
    ...
    Public Function ExportToExcelVatNonVat(ByVal a_sData As DataSet, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String,
                                         ByVal xlObject As Excel.Application,
                                         ByVal xlWB As Excel.Workbook) As Boolean
        a_sErrorMessage = String.Empty
        Dim bRetVal As Boolean = False
    ...
    Public Function ExportTaxSaleDetail(ByVal a_sData As DataSet, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String,
                                         ByVal xlObject As Excel.Application,
                                         ByVal xlWB As Excel.Workbook) As Boolean
        a_sErrorMessage = String.Empty
        Dim bRetVal As Boolean = False
    ...
    Public Function ExportVatBankDetail(ByVal a_sData As DataSet, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String,
                                         ByVal xlObject As Excel.Application,
                                         ByVal xlWB As Excel.Workbook) As Boolean
        a_sErrorMessage = String.Empty
        Dim bRetVal As Boolean = False
    ...
    Public Function ExportAnnuxer24(ByVal a_sData As DataSet, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String,
                                         ByVal xlObject As Excel.Application,
                                         ByVal xlWB As Excel.Workbook) As Boolean
        a_sErrorMessage = String.Empty
        Dim bRetVal As Boolean = False
    ...
    Public Function ExportForm24_Annexure_A1(ByVal a_sData As DataSet, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String,
                                         ByVal xlObject As Excel.Application,
                                         ByVal xlWB As Excel.Workbook) As Boolean
        a_sErrorMessage = String.Empty
        Dim bRetVal As Boolean = False
    ...
    Public Function ExportForm24_Annexure_A2(ByVal a_sData As DataSet, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String,
                                         ByVal xlObject As Excel.Application,
                                         ByVal xlWB As Excel.Workbook) As Boolean
        a_sErrorMessage = String.Empty
        Dim bRetVal As Boolean = False
    ...
    Public Function ExportCommAgent(ByVal a_sData As DataSet, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String,
                                         ByVal xlObject As Excel.Application,
                                         ByVal xlWB As Excel.Workbook) As Boolean
        a_sErrorMessage = String.Empty
        Dim bRetVal As Boolean = False
    ...
    Public Function ExportForm24_Annexure_C(ByVal a_sData As DataSet, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String,
                                         ByVal xlObject As Excel.Application,
                                         ByVal xlWB As Excel.Workbook) As Boolean
        a_sErrorMessage = String.Empty
        Dim bRetVal As Boolean = False
    ...
    Public Function ExportForm24_Annexure_D(ByVal a_sData As DataSet, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String,
                                         ByVal xlObject As Excel.Application,
                                         ByVal xlWB As Excel.Workbook) As Boolean
        a_sErrorMessage = String.Empty
        Dim bRetVal As Boolean = False
    ...
    Public Function ExportForm24_Annexure_E(ByVal a_sData As DataSet, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String,
                                         ByVal xlObject As Excel.Application,
                                         ByVal xlWB As Excel.Workbook) As Boolean
        a_sErrorMessage = String.Empty
        Dim bRetVal As Boolean = False
    ...
    Public Function ExportForm24_Annexure_F(ByVal a_sData As DataSet, ByVal a_sFileTitle As String, ByRef a_sErrorMessage As String,
                                         ByVal xlObject As Excel.Application,
                                         ByVal xlWB As Excel.Workbook) As Boolean
        a_sErrorMessage = String.Empty
        Dim bRetVal As Boolean = False
