...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = " Select H.*, Sg.Name + ',' + IsNull(C1.CityName,'') As SaleToPartyDesc, G.Description AS GodownDesc," & _
    ...
    Private Function FFilterUsedItems() As String
        ...
        Try
            With Dgl1
                For I = 0 To .Rows.Count - 1
                    If .Item(Col1Item, I).Value <> "" Then
                        FFilterUsedItems += " And Code +  IsNull(StockInDocID,'') +  IsNull(StockInDocIDSr,'') <> '" & Dgl1.AgSelectedValue(Col1Item, I) & "' + '" & Dgl1.AgSelectedValue(Col1ReferenceDocId, I) & "' + '" & Dgl1.Item(Col1ReferenceDocIdSr, I).Value & "'"
                    End If
                Next
            End With
        Catch ex As Exception
    ...
    Private Sub FPostInSaleChallan(ByVal Conn As SqlClient.SqlConnection, ByVal Cmd As SqlClient.SqlCommand)
        ...
        If AgL.XNull(AgL.Dman_Execute(mQry, AgL.GcnRead).ExecuteScalar) > 0 Then
            ...
            mQry = "Insert Into Stock(DocID, Sr, V_Type, V_Prefix, V_Date, V_No, RecID, Div_Code, Site_Code, " & _
                     ...
                     " Case When  IsNull(L.Qty,0) >= 0 Then L.Qty Else 0 End As Qty_Iss, " & _
                     " Case When  IsNull(L.Qty,0) < 0 Then L.Qty Else 0 End As Qty_Rec, " & _
