...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.LblDescriptionReq.Location = New System.Drawing.Point(318, 70)
        ...
        Me.TxtDescription.Location = New System.Drawing.Point(334, 62)
        ...
        Me.LblDescription.Location = New System.Drawing.Point(183, 65)
        ...
        'PnlCustomGrid
        '
        Me.PnlCustomGrid.Location = New System.Drawing.Point(218, 104)
        Me.PnlCustomGrid.Name = "PnlCustomGrid"
        Me.PnlCustomGrid.Size = New System.Drawing.Size(424, 190)
        ...
        Me.TxtCustomFields.Location = New System.Drawing.Point(447, 319)
...
#End Region
    ...
    Private Sub FrmYarn_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        ...
        If Topctrl1.Mode = "Add" Then
            mQry = "Select count(*) From ItemInvoiceGroup Where Description ='" & TxtDescription.Text & "' "
            If AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar > 0 Then Err.Raise(1, , "Description Already Exist!")
        Else
            mQry = "Select count(*) From ItemInvoiceGroup Where Description ='" & TxtDescription.Text & "' And Code<>'" & mInternalCode & "'  "
            If AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar > 0 Then Err.Raise(1, , "Description Already Exist!")
        End If
    End Sub

    Private Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        AgL.PubFindQry = "SELECT Code, Description  " & _
                            " FROM ItemInvoiceGroup "
        AgL.PubFindQryOrdBy = "[Description]"
    End Sub

    Private Sub FrmYarn_BaseEvent_Form_PreLoad() Handles Me.BaseEvent_Form_PreLoad
        MainTableName = "ItemInvoiceGroup"
        PrimaryField = "Code"
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = "Update ItemInvoiceGroup " & _
                "   SET  " & _
    ...
    Private Sub FrmQuality1_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        mQry = "Select Code as Code, Description From ItemInvoiceGroup " & _
    ...
    Private Sub FrmQuality1_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = "Select * " & _
            " From ItemInvoiceGroup Where Code='" & SearchCode & "'"
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                TxtCustomFields.Tag = AgCustomFields.ClsMain.FGetCustomFieldFromV_Type(ClsMain.Temp_NCat.ItemInvoiceGroup, AgL.GcnRead)
    ...
    Private Sub FrmItemInvoiceGroup_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        AgCustomGrid1.Ini_Grid(mSearchCode)
        AgCustomGrid1.SplitGrid = False
    End Sub

    Private Sub FrmItemInvoiceGroup_BaseEvent_Topctrl_tbAdd() Handles Me.BaseEvent_Topctrl_tbAdd
        TxtCustomFields.Tag = AgCustomFields.ClsMain.FGetCustomFieldFromV_Type(ClsMain.Temp_NCat.ItemInvoiceGroup, AgL.GCn)
        AgCustomGrid1.AgCustom = TxtCustomFields.Tag
