...
BTNERR:
    ...
    Public Sub FSetParent(ByVal Frm As Form, ByVal StrPermission As String, ByVal DTVar As DataTable)
        ...
        LblDocId.Text = ""
    End Sub
    Public Sub FIniForm(ByRef DTMaster As DataTable, ByVal DBCon As SQLiteConnection, ByVal StrSQL As String,
    Optional ByVal BlnIsMaster As Boolean = False, Optional ByVal CmbMaster As System.Windows.Forms.ComboBox = Nothing,
    Optional ByVal StrCmbValue As String = "", Optional ByVal StrCmbDisplay As String = "",
    Optional ByVal BytDel As Byte = 0, Optional ByVal BytRefresh As Byte = 0)
        ...
        If LblDocId.Text <> "" Or BytRefresh = 1 Or BytDel = 1 Then
            ...
            ADTemp = New SQLiteDataAdapter(StrSQL, DBCon)
    ...
    End Sub
    Public Sub FIniForm(ByRef DTMaster As DataTable, ByVal DBCon As OleDb.OleDbConnection, ByVal StrSQL As String,
    Optional ByVal BlnIsMaster As Boolean = False, Optional ByVal CmbMaster As System.Windows.Forms.ComboBox = Nothing,
    Optional ByVal StrCmbValue As String = "", Optional ByVal StrCmbDisplay As String = "",
    Optional ByVal BytDel As Byte = 0, Optional ByVal BytRefresh As Byte = 0)
