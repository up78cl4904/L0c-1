...
#End Region
    ...
    Private Sub FrmProductionOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = "UPDATE IE_Shipment_Log " &
                " SET PurchaseOrder = " & AgL.Chk_Text(TxtPurchaseOrder.AgSelectedValue) & ", " &
                " PurchaseOrderReferenceNo = " & AgL.Chk_Text(TxtPurchaseOrderReferenceNo.Text) & ", " &
                " InvoiceNo = " & AgL.Chk_Text(TxtInvoiceNo.Text) & ", " &
                " InvoiceDate = " & AgL.Chk_Text(TxtInvoiceDate.Text) & ", " &
                " BillOfEntryNo = " & AgL.Chk_Text(TxtBillOfEntryNo.Text) & ", " &
                " BillOfEntryDate = " & AgL.Chk_Text(TxtBillOfEntryDate.Text) & ", " &
                " ShippingLine = " & AgL.Chk_Text(TxtShippingLine.Text) & ", " &
                " CountryOfOrigin = " & AgL.Chk_Text(TxtCountryOfOrigin.Text) & ", " &
                " InsuranceDetail = " & AgL.Chk_Text(TxtInsuranceDetail.Text) & ", " &
                " PortOfDispatch = " & AgL.Chk_Text(TxtPortOfDispatch.Text) & ", " &
                " PortOfDicharge = " & AgL.Chk_Text(TxtPortOfDicharge.Text) & ", " &
                " FinalPlaceOfDelivery = " & AgL.Chk_Text(TxtFinalPlaceOfDelivery.Text) & ", " &
                " ETAAtIndianSeaPort = " & AgL.Chk_Text(TxtETAAtIndianSeaPort.Text) & ", " &
                " ETAAtICD = " & AgL.Chk_Text(TxtETAAtICD.Text) & ", " &
                " CHA = " & AgL.Chk_Text(TxtCHA.AgSelectedValue) & ", " &
                " ShipperInformationDate = " & AgL.Chk_Text(TxtShipperInformationDate.Text) & ", " &
                " ShipperInformationRemark = " & AgL.Chk_Text(TxtShipperInformationRemark.Text) & ", " &
                " DocSubmissionDateToCHA = " & AgL.Chk_Text(TxtDocSubmissionDateToCHA.Text) & ", " &
                " DocRealisationDate = " & AgL.Chk_Text(TxtDocRealisationDate.Text) & ", " &
                " DutyAmountPaidDate = " & AgL.Chk_Text(TxtDutyAmountPaidDate.Text) & ", " &
                " ShipmentReleaseDate = " & AgL.Chk_Text(TxtShipmentReleaseDate.Text) & ", " &
                " Transporter = " & AgL.Chk_Text(TxtTransporter.AgSelectedValue) & ", " &
                " VehicleNo = " & AgL.Chk_Text(TxtVehicleNo.Text) & ", " &
                " DriverName = " & AgL.Chk_Text(TxtDriverName.Text) & ", " &
                " ArrivalDateAtFactory = " & AgL.Chk_Text(TxtArrivalDateAtFactory.Text) & ", " &
                " VehicleReturnDate = " & AgL.Chk_Text(TxtVehicleReturnDate.Text) & ", " &
                " ProofSubmissionDate = " & AgL.Chk_Text(TxtProofSubmissionDate.Text) & ", " &
                " BankAdviceNo = " & AgL.Chk_Text(TxtBankAdviceNo.Text) & ", " &
                " BankAdviceDate = " & AgL.Chk_Text(TxtBankAdviceDate.Text) & ", " &
                " ExchangeRate = " & Val(TxtExchangeRate.Text) & ", " &
                " BillOfLadingNo = " & AgL.Chk_Text(TxtBillOfLadingNo.Text) & ", " &
                " BillOfLadingDate = " & AgL.Chk_Text(TxtBillOfLadingDate.Text) & ", " &
                " ShipmentOnBoardDate = " & AgL.Chk_Text(TxtShipmentOnBoardDate.Text) & ", " &
                " VesselName = " & AgL.Chk_Text(TxtVesselName.Text) & " " &
        ...
        With Dgl1
            For I = 0 To .RowCount - 1
                If .Item(Col1Document, I).Value <> "" Then
                    mSr += 1
                    mQry = "INSERT INTO dbo.IE_ShipmentDoc_Log(UID, DocId, Sr, Document, DocumentNo) " &
                            " VALUES (" & AgL.Chk_Text(mSearchCode) & ", " &
                            " " & AgL.Chk_Text(mInternalCode) & ",	" & mSr & ", " &
                            " " & AgL.Chk_Text(.AgSelectedValue(Col1Document, I)) & ",	" &
        ...
        With Dgl2
            For I = 0 To .RowCount - 1
                If .Item(Col2BOE, I).Value <> "" Then
                    mSr += 1
                    mQry = "INSERT INTO IE_ShipmentBOE_Log(UID, DocId, Sr, BOE, FCValue, INRValue, Term, DueDate) " &
                            " VALUES (" & AgL.Chk_Text(mSearchCode) & "," &
                            " " & AgL.Chk_Text(mInternalCode) & ",	" & mSr & ", " &
                            " " & AgL.Chk_Text(.Item(Col2BOE, I).Value) & ", " &
                            " " & Val(.Item(Col2FCValue, I).Value) & ",	" &
                            " " & Val(.Item(Col2INRValue, I).Value) & ", " &
                            " " & AgL.Chk_Text(.Item(Col2Term, I).Value) & ", " &
        ...
        With Dgl3
            For I = 0 To .RowCount - 1
                If .Item(Col3Item, I).Value <> "" Then
                    mSr += 1
                    mQry = "INSERT INTO IE_ShipmentItem_Log(UID, DocId, Sr, Item, ItemDescription, Unit, Qty, " &
                            " Rate, Amount, ContainerNo, KindsOfPackages ) " &
                            " VALUES(" & AgL.Chk_Text(mSearchCode) & ", " &
                            " " & AgL.Chk_Text(mInternalCode) & ",	" & mSr & ", " &
                            " " & AgL.Chk_Text(.AgSelectedValue(Col3Item, I)) & ", " &
                            " " & AgL.Chk_Text(.Item(Col3ItemDescription, I).Value) & ", " &
                            " " & AgL.Chk_Text(.Item(Col3Unit, I).Value) & ", " &
                            " " & Val(.Item(Col3Qty, I).Value) & ", " & Val(.Item(Col3Rate, I).Value) & ", " &
                            " " & Val(.Item(Col3Amount, I).Value) & ", " &
                            " " & AgL.Chk_Text(.Item(Col3ContainerNo, I).Value) & ", " &
    ...
    Private Sub TempShipmentEntry_BaseFunction_CreateHelpDataSet() Handles Me.BaseFunction_CreateHelpDataSet
        mQry = " SELECT Po.DocID AS Code, Po.V_Type + '-' + Convert(NVARCHAR,Po.V_No), Po.ReferenceNo " &
                " FROM PurchOrder Po "
        HelpDataSet.PurchaseOrder = AgL.FillData(mQry, AgL.GCn)

        mQry = " Select S.Code As Code, S.Description As Port " &
                " From SeaPort S "
        HelpDataSet.Port = AgL.FillData(mQry, AgL.GCn)

        mQry = " Select Sg.SubCode As Code, Sg.DispName As Name " &
                " From SubGroup Sg "
        HelpDataSet.CHA = AgL.FillData(mQry, AgL.GCn)

        mQry = " Select Sg.SubCode As Code, Sg.DispName As Transporter " &
                " From Transporter T " &
                " LEFT JOIN SubGroup Sg On T.SubCode = Sg.SubCode "
        HelpDataSet.Transporter = AgL.FillData(mQry, AgL.GCn)

        mQry = " SELECT D.Code AS Code, D.Description AS Document  " &
                " FROM IE_Doc D "
        HelpDataSet.Document = AgL.FillData(mQry, AgL.GCn)

        mQry = " SELECT D.DocumentNo AS Code, D.DocumentNo, D.Document  " &
                " FROM IE_DocEntry  D " &
                " WHERE D.DocumentNo IS NOT NULL  "
        HelpDataSet.DocumentNo = AgL.FillData(mQry, AgL.GCn)

        mQry = " Select I.Code As Code, I.Description As Item, I.Unit " &
                " From Item I "
