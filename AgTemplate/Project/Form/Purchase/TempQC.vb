...
Public Class TempQC
    ...
    Dim StrTblParamIni As String = " Declare @TblParm AS Table(TSr INT, Sr INT, Parameter NVARCHAR(50), StdValue NVARCHAR(50), " &
                                    " ActValue NVARCHAR(50), Qty FLOAT, QcQty FLOAT, PassedQty FLOAT, RejectQty Float, " &
                                    " Unit NVARCHAR (10), MeasurePerPcs FLOAT , MeasureUnit NVARCHAR (10) ,TotalMeasure FLOAT ," &
                                    " TotalPassedMeasure FLOAT ,	TotalRejectMeasure FLOAT ,	Remarks  NVARCHAR (255) , " &
...
#End Region
    ...
    Private Sub TempBookIssue_BaseEvent_Approve_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand) Handles Me.BaseEvent_Approve_InTrans
            ...
            With Dgl1
                For I = 0 To .RowCount - 1
                    If .AgSelectedValue(Col1Item, I) <> "" And .AgSelectedValue(Col1ChallanNo, I) <> "" Then
                        ...
                        mQry = " UPDATE PurchChallanDetail SET QcQty = (  " &
                                " SELECT IfNull(QCQty,0) FROM PurchChallanDetail  " &
                                " WHERE DocId =" & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1TempChallanNo, I)) & " " &
                                " AND  Item=" & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1TempItem, I)) & "  " &
                                " ) - " & Val(Dgl1.Item(Col1TempQCQty, I).Value) & "" &
                                " WHERE DocId =" & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1TempChallanNo, I)) & " " &
                                " AND  Item=" & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1TempItem, I)) & "  "
            ...
            With Dgl1
                For I = 0 To .RowCount - 1
                    ...
                    If .AgSelectedValue(Col1Item, I) <> "" And .AgSelectedValue(Col1ChallanNo, I) <> "" Then
                        ...
                        mQry = " UPDATE PurchChallanDetail SET QcQty = (  " &
                                " SELECT IfNull(QCQty,0) FROM PurchChallanDetail  " &
                                " WHERE DocId =" & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1ChallanNo, I)) & " " &
    ...
    Private Sub FrmTempRequisition_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        ...
        AgL.PubFindQry = " SELECT H.DocID AS SearchCode, H.DeliveryMeasure AS [Delivery Measure], H.V_Type AS [QC Type], H.V_Prefix AS Prefix, H.V_Date AS Date, H.V_No AS [QC No] , " &
                            " SG.DispName AS [QC By], H.Remarks, H.TotalQty AS [Total Qty], H.TotalPassedQty AS [Total Passed Qty], H.TotalRejectQty AS [Total Reject Qty], H.TotalMeasure AS [Total Measure], " &
                            " H.TotalPassedMeasure AS [Total Passed Measure], H.TotalRejectMeasure AS [Total Reject Measure], H.EntryBy AS [Entry By], H.EntryDate AS [Entry Date], H.EntryType AS [Entry Type],  " &
                            ...
                            " SM.Name AS [Site Name], D.Div_Name AS Division, DE.Description AS Department, PC.ReferenceNo AS [Challan No] " &
                            " FROM  QC H  " &
                            ...
                            " LEFT JOIN PurchChallan PC ON PC.DocID =H.PurchChallan   " &
                            " LEFT JOIN SubGroup SG ON SG.SubCode=H.QcBy   " &
                             " LEFT JOIN Voucher_type Vt ON H.V_Type = Vt.V_Type " &
                            " Where IfNull(H.IsDeleted,0) = 0  " & mCondStr
    ...
    Private Sub FrmTempRequisition_BaseEvent_FindLog() Handles Me.BaseEvent_FindLog
        ...
        AgL.PubFindQry = " SELECT H.UID AS SearchCode, H.DeliveryMeasure AS [Delivery Measure], H.V_Type AS [QC Type], H.V_Prefix AS Prefix, H.V_Date AS Date, H.V_No AS [QC No] , " &
                    " SG.DispName AS [QC By], H.Remarks, H.TotalQty AS [Total Qty], H.TotalPassedQty AS [Total Passed Qty], H.TotalRejectQty AS [Total Reject Qty], H.TotalMeasure AS [Total Measure], " &
                    " H.TotalPassedMeasure AS [Total Passed Measure], H.TotalRejectMeasure AS [Total Reject Measure], H.EntryBy AS [Entry By], H.EntryDate AS [Entry Date], H.EntryType AS [Entry Type],  " &
                    " H.EntryStatus AS [Entry Status], H.ApproveBy AS [Approve By], H.ApproveDate AS [Approve Date], H.MoveToLog AS [Move To Log], H.MoveToLogDate AS [Move To Log Date],  H.Status,  " &
                    " SM.Name AS [Site Name], D.Div_Name AS Division, DE.Description AS Department, PC.ReferenceNo AS [Challan No]   " &
    ...
    Private Sub FrmTempRequisition_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        ' Dim bUID As String
        mQry = " UPDATE QC_Log SET " &
                    " PurchChallan = " & AgL.Chk_Text(TxtChallanNo.AgSelectedValue) & ", " &
                    " QcBy = " & AgL.Chk_Text(TxtQCBy.AgSelectedValue) & ", " &
                    " Remarks = " & AgL.Chk_Text(TxtRemarks.Text) & ", " &
                    " TotalQty = " & Val(LblValTotalQty.Text) & ", " &
                    " TotalPassedQty = " & Val(LblValueTotalPassed.Text) & ", " &
                    " TotalRejectQty = " & Val(LblValTotalRejected.Text) & " " &
        ...
        With Dgl1
            For I = 0 To .RowCount - 1
                If .Item(Col1Item, I).Value <> "" Then
                    ...
                    mQry = " INSERT INTO QCDetail_Log (DocId, Sr, Item, Qty, QcQty, PassedQty, " &
                            " RejectQty, Unit, MeasurePerPcs, MeasureUnit, TotalMeasure,  " &
                            " TotalPassedMeasure, TotalRejectMeasure, Remarks, UID, PurchChallan) " &
                            " VALUES (" & AgL.Chk_Text(mInternalCode) & "," & mSr & ", " &
                            " " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1Item, I)) & ", " & Val(Dgl1.Item(Col1Qty, I).Value) & ", " & Val(Dgl1.Item(Col1QCQty, I).Value) & ", " &
                            " " & Val(Dgl1.Item(Col1PassedQty, I).Value) & ", " & Val(Dgl1.Item(Col1RejectedQty, I).Value) & ", " & AgL.Chk_Text(Dgl1.Item(Col1Unit, I).Value) & ", " &
                            " " & Val(Dgl1.Item(Col1MeasurePerPcs, I).Value) & ", " & AgL.Chk_Text(Dgl1.Item(Col1MeasureUnit, I).Value) & ", " & Val(Dgl1.Item(Col1TotalMeasure, I).Value) & ",  " &
                            " " & Val(Dgl1.Item(Col1TotalPassedMeasure, I).Value) & ", " & Val(Dgl1.Item(Col1TotalRejectMeasure, I).Value) & ",  " &
        ...
        With dsTemp.Tables(0)
            ...
            If .Rows.Count > 0 Then
                For I = 0 To dsTemp.Tables(0).Rows.Count - 1
                    mQry = " INSERT INTO QCParameterDetail_Log (DocId, TSr, Sr, Parameter, Qty, " &
                            " QcQty, PassedQty, RejectQty, Unit, MeasurePerPcs, MeasureUnit,  " &
                            " TotalMeasure, TotalPassedMeasure, TotalRejectMeasure, Remarks,  " &
                            " UID, StdValue, ActValue) " &
                            " VALUES (" & AgL.Chk_Text(mInternalCode) & "," & Val(AgL.VNull(.Rows(I)("TSr"))) & ", " & Val(AgL.VNull(.Rows(I)("Sr"))) & ", " &
                            " " & AgL.Chk_Text(AgL.XNull(.Rows(I)("Parameter"))) & "," & Val(AgL.VNull(.Rows(I)("Qty"))) & ", " & Val(AgL.VNull(.Rows(I)("QCQty"))) & ",  " &
                            " " & Val(AgL.VNull(.Rows(I)("PassedQty"))) & ", " & Val(AgL.VNull(.Rows(I)("RejectQty"))) & ", " & AgL.Chk_Text(AgL.XNull(.Rows(I)("Unit"))) & ", " & Val(AgL.VNull(.Rows(I)("MeasurePerPcs"))) & ",  " &
                            " " & AgL.Chk_Text(AgL.XNull(.Rows(I)("MeasureUnit"))) & ", " & Val(AgL.VNull(.Rows(I)("TotalMeasure"))) & ", " & Val(AgL.VNull(.Rows(I)("TotalPassedMeasure"))) & ",  " &
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                With DsTemp.Tables(0)
                    If .Rows.Count > 0 Then
                        For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                            StrTblParam += " INSERT INTO @TblParm  ( TSr, Sr, Parameter, Qty, QcQty, " &
                                            " PassedQty, RejectQty, Unit, MeasurePerPcs, MeasureUnit, TotalMeasure,  " &
                                            " TotalPassedMeasure, TotalRejectMeasure, Remarks,  " &
                                            " UID, StdValue, ActValue) " &
                                            " VALUES ( " & Val(AgL.VNull(.Rows(I)("TSr"))) & ", " & Val(AgL.VNull(.Rows(I)("Sr"))) & ", " &
                                            " " & AgL.Chk_Text(AgL.XNull(.Rows(I)("Parameter"))) & ", " & Val(AgL.VNull(.Rows(I)("Qty"))) & ", " & Val(AgL.VNull(.Rows(I)("QCQty"))) & ",  " &
                                            " " & Val(AgL.VNull(.Rows(I)("PassedQty"))) & ", " & Val(AgL.VNull(.Rows(I)("RejectQty"))) & ", " &
                                            " " & AgL.Chk_Text(AgL.XNull(.Rows(I)("Unit"))) & ", " & Val(AgL.VNull(.Rows(I)("MeasurePerPcs"))) & ", " & AgL.Chk_Text(AgL.XNull(.Rows(I)("MeasureUnit"))) & ",  " &
                                            " " & Val(AgL.VNull(.Rows(I)("TotalMeasure"))) & ", " & Val(AgL.VNull(.Rows(I)("TotalPassedMeasure"))) & ", " &
                                            " " & Val(AgL.VNull(.Rows(I)("TotalRejectMeasure"))) & ",  " &
                                            " " & AgL.Chk_Text(AgL.XNull(.Rows(I)("Remarks"))) & ", " & AgL.Chk_Text(.Rows(I)("UID").ToString()) & ", " &
            ...
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                Case Col1Item
                    If TxtChallanNo.AgSelectedValue <> "" And Dgl1.AgSelectedValue(Col1ChallanNo, Dgl1.CurrentCell.RowIndex) = "" Then
                        ...
                        Dgl1.AgRowFilter(Dgl1.Columns(Col1Item).Index) = " Code = " & AgL.Chk_Text(Dgl1.AgSelectedValue(Dgl1.CurrentCell.ColumnIndex, Dgl1.CurrentCell.RowIndex)) & "  " &
                                " OR IsDeleted = 0 " &
                    ...
                    If Dgl1.AgSelectedValue(Col1ChallanNo, Dgl1.CurrentCell.RowIndex) <> "" Then
                        ...
                        Dgl1.AgRowFilter(Dgl1.Columns(Col1Item).Index) = " Code = " & AgL.Chk_Text(Dgl1.AgSelectedValue(Dgl1.CurrentCell.ColumnIndex, Dgl1.CurrentCell.RowIndex)) & "  " &
                                " OR IsDeleted = 0 " &
                                " And ChallanDocId = '" & Dgl1.AgSelectedValue(Col1ChallanNo, Dgl1.CurrentCell.RowIndex) & "'" &
                                " And Div_Code = '" & TxtDivision.AgSelectedValue & "' " &
                                " And Status ='" & AgTemplate.ClsMain.EntryStatus.Active & "' " &
                                " And BalQty > 0  "
                    End If
                ...
                Case Col1ChallanNo
                    If TxtChallanNo.AgSelectedValue <> "" Then
                        Dgl1.AgRowFilter(Dgl1.Columns(Col1ChallanNo).Index) = " Code = " & AgL.Chk_Text(Dgl1.AgSelectedValue(Dgl1.CurrentCell.ColumnIndex, Dgl1.CurrentCell.RowIndex)) & " OR  " &
                            " IsDeleted = 0 " &
                            " And Div_Code = '" & TxtDivision.AgSelectedValue & "' " &
                            " And Status='" & AgTemplate.ClsMain.EntryStatus.Active & "' " &
                            " AND Code=" & AgL.Chk_Text(TxtChallanNo.AgSelectedValue) & "  " &
                            " AND BalQty > 0 "
                    Else
                        Dgl1.AgRowFilter(Dgl1.Columns(Col1ChallanNo).Index) = " Code = " & AgL.Chk_Text(Dgl1.AgSelectedValue(Dgl1.CurrentCell.ColumnIndex, Dgl1.CurrentCell.RowIndex)) & " OR " &
                            " IsDeleted = 0 " &
                ...
                Case TxtChallanNo.Name
                    If TxtVendor.AgSelectedValue <> "" Then
                        sender.AgRowFilter = " IsDeleted = 0  " &
                            ...
                            " AND Vendor = " & AgL.Chk_Text(TxtVendor.AgSelectedValue) & " " &
                            " AND BalQty > 0  "
                    Else
                        sender.AgRowFilter = "  IsDeleted = 0 " &
                                " And Status ='" & AgTemplate.ClsMain.EntryStatus.Active & "' " &
                            ...
                            With FrmObj.Dgl1
                                For I = 0 To FrmObj.Dgl1.RowCount - 1
                                    StrTblParam += " INSERT INTO @TblParm  ( TSr, Sr, Parameter, Qty, QcQty, " &
                                                ...
                                                " TotalPassedMeasure, TotalRejectMeasure, Remarks, " &
                                                " StdValue, ActValue) " &
                                                " VALUES ( " & Val(Dgl1.Item(ColSNo, Dgl1.CurrentCell.RowIndex).Value) & ", " & I + 1 & ", " &
                                                " " & AgL.Chk_Text(.Item(FrmObj.Col1Parameter, I).Value) & ", " & Val(.Item(FrmObj.Col1Qty, I).Value) & ", " & Val(.Item(FrmObj.Col1QcQty, I).Value) & ",  " &
                                                " " & Val(.Item(FrmObj.Col1PassedQty, I).Value) & ", " & Val(.Item(FrmObj.Col1RejectQty, I).Value) & ", " &
                                                " " & AgL.Chk_Text(.Item(FrmObj.Col1Unit, I).Value) & ", " & Val(.Item(FrmObj.Col1MeasurePerPcs, I).Value) & ", " & AgL.Chk_Text(.Item(FrmObj.Col1MeasureUnit, I).Value) & ",  " &
                                                " " & Val(.Item(FrmObj.Col1TotalMeasure, I).Value) & ", " & Val(.Item(FrmObj.Col1TotalPassedMeasure, I).Value) & ", " &
                                                " " & Val(.Item(FrmObj.Col1TotalRejectMeasure, I).Value) & ", " & AgL.Chk_Text(.Item(FrmObj.Col1Remarks, I).Value) & " , " &
    ...
    Private Sub TempQC_BaseFunction_CreateHelpDataSet() Handles Me.BaseFunction_CreateHelpDataSet
        mQry = " SELECT  V.SubCode AS Code,SG.DispName AS [Vendor Name], " &
                     " IfNull(SG.IsDeleted,0) AS IsDeleted, " &
        ...
        mQry = " SELECT E.SubCode AS Code, SG.DispName AS Name, " &
                " IfNull(SG.IsDeleted,0) AS IsDeleted, " &
                " IfNull(SG.Status , '" & AgTemplate.ClsMain.EntryStatus.Active & "') AS Status,SG.Div_Code " &
                " FROM Employee E  " &
        ...
        mQry = " SELECT H.DocID AS Code,H.V_Type + '-' + Convert(NVARCHAR(5),H.V_No ) AS ChllanNo, " &
                " H.V_Date AS [Challan Date ],H.ReferenceNo AS [Manual No],SG.DispName AS [Vendor Name], " &
                " H.VendorDocNo AS [Vendor Doc. No],H.vendor, " &
                " IfNull(H.IsDeleted,0) AS IsDeleted,   " &
                " IfNull(H.Status , '" & AgTemplate.ClsMain.EntryStatus.Active & "') AS Status, " &
                " H.Div_Code , Vt.NCat, H.TotalQty - IfNull(V1.QCQty,0) AS BalQty, H.MoveToLog " &
                " FROM PurchChallan H " &
                " LEFT JOIN  " &
                " ( " &
                " SELECT L.DocId, Sum(IfNull(L.QcQty,0))  AS QCQty " &
                " FROM PurchChallanDetail L  " &
                " GROUP BY  L.DocId " &
                " ) V1 ON V1.DocId =H.DocId " &
        ...
        mQry = " SELECT I.Code, I.Description AS Item,I.Unit,IfNull(I.IsDeleted,0) AS IsDeleted, '' AS ChallanDocId, " &
                    " IfNull(I.Status , '" & AgTemplate.ClsMain.EntryStatus.Active & "') AS Status, " &
                    " I.Div_Code,I.ItemType,0 AS BalQty  " &
                    " FROM Item I "
        HelpDataSet.Item = AgL.FillData(mQry, AgL.GCn)

        mQry = " SELECT L.Item AS Code,  I.Description AS Item,I.Unit,H.DocId AS ChallanDocId, " &
                    " IfNull(H.IsDeleted,0) AS IsDeleted, " &
                    " IfNull(H.Status ,'" & AgTemplate.ClsMain.EntryStatus.Active & "' ) AS Status, " &
                    " H.Div_Code , L.Qty, I.Measure, I.MeasureUnit, L.Qty - IfNull(L.QcQty,0) AS balQty,I.ItemType " &
                    " FROM PurchChallanDetail L " &
                    " LEFT JOIN PurchChallan H ON H.DocID = L.DocId  " &
                    " LEFT JOIN Item I ON I.Code=L.Item  " &
                    " Left Join " &
                    " ( " &
                    " SELECT QD.Item,sum(IfNull(QD.QcQty,0)) AS  QcQty ,QD.PurchChallan  " &
                    " FROM QcDetail QD " &
                    " GROUP BY QD.Item,QD.PurchChallan  " &
