...
Public Class TempTransaction
    ...
    Public Event BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand)
    ...
    Public Event BaseEvent_Approve_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand)
    Public Event BaseEvent_ApproveDeletion_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand)
    ...
    Public Event BaseEvent_Discard_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand)
    ...
    Private Sub Topctrl1_tbDel() Handles Topctrl1.tbDel
        ...
        Try
            ...
            StrVPrefixStatus = AgL.Dman_Execute("SELECT IfNull(Status_Delete,'" & AgTemplate.ClsMain.EntryStatus.Active & "'), Date_From , Date_To , Prefix  FROM Voucher_Prefix WHERE Date_From <= '" & TxtV_Date.Text & "' AND Date_To >= '" & TxtV_Date.Text & "' And V_Type = '" & TxtV_Type.Tag & "' ", AgL.GCn).ExecuteScalar
    ...
    Private Sub Topctrl1_tbEdit() Handles Topctrl1.tbEdit
        ...
        StrVPrefixStatus = AgL.Dman_Execute("SELECT IfNull(Status_Edit,'" & AgTemplate.ClsMain.EntryStatus.Active & "'), Date_From , Date_To , Prefix  FROM Voucher_Prefix WHERE Date_From <= '" & TxtV_Date.Text & "' AND Date_To >= '" & TxtV_Date.Text & "' And V_Type = '" & TxtV_Type.Tag & "' ", AgL.GCn).ExecuteScalar
        If StrVPrefixStatus <> AgTemplate.ClsMain.EntryStatus.Active Then
            If AgL.PubUserName.ToUpper = AgLibrary.ClsConstant.PubSuperUserName Or AgL.PubUserName.ToUpper = "SA" Then
                If MsgBox("Entry is " & StrVPrefixStatus & " for Date " & TxtV_Date.Text & ", Do you want to continue?", MsgBoxStyle.DefaultButton2 + MsgBoxStyle.YesNo) = MsgBoxResult.No Then
                    Topctrl1.FButtonClick(14, True)
    ...
    Sub ProcApporve(ByVal mConn As SqliteConnection, ByVal mCmd As SqliteCommand)
    ...
    Public Sub FMoveToLog(ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand, Optional ByVal mEntryType As String = "")
        'Dim mGuid$
        'Dim I As Integer
