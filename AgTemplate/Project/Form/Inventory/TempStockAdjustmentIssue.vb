...
#End Region
    ...
    Private Sub FrmProductionOrder_BaseEvent_FindLog() Handles Me.BaseEvent_FindLog
        ...
        AgL.PubFindQry = " SELECT H.UID as SearchCode, Vt.Description AS [Entry Type], " &
    ...
    Private Sub FrmProductionOrder_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        ...
        AgL.PubFindQry = " SELECT H.DocID as SearchCode, Vt.Description AS [Entry Type], " &
                            " H.V_Date AS [Entry Date], H.V_No AS [Entry No] " &
                            " FROM StockHead H " &
                            " LEFT JOIN voucher_type Vt ON H.V_Type = Vt.V_Type " &
                            " Where 1=1  " & mCondStr
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                ...
                mQry = "INSERT INTO Stock_Log (UID, DocId, Sr, V_Type, V_Prefix, " &
                        ...
                        " MeasurePerPcs, Measure_Iss, MeasureUnit, Status, Rate, Amount, Cost, Remarks) " &
    ...
    Private Sub FrmProductionOrder_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        mQry = "SELECT I.Code, I.Description, I.Unit, I.ItemType, I.SalesTaxPostingGroup, Measure, MeasureUnit , " &
                " IfNull(I.IsDeleted ,0) AS IsDeleted, " &
        ...
        mQry = "Select Sg.SubCode As Code, Sg.DispName As Name, IfNull(SG.IsDeleted,0) AS IsDeleted, SG.Div_Code , " &
