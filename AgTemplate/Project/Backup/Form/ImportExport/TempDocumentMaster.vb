...
#End Region
    ...
    Private Sub FrmDocument_BaseEvent_FindLog() Handles Me.BaseEvent_FindLog
        ...
        AgL.PubFindQry = "SELECT UID, Description [Document Description], Nature " & _
                        " FROM IE_Doc_Log " & mConStr & _
    ...
    Private Sub FrmDocument_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        Dim mConStr$ = ""
        mConStr = "WHERE 1=1 " & AgL.RetDivisionCondition(AgL, "Div_Code") & " "
        AgL.PubFindQry = "SELECT Code, Description [Document Description], Nature " & _
                        " FROM IE_Doc " & mConStr & _
    ...
    Private Sub FrmDocument_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = "Update IE_Doc_Log " & _
                "   SET  " & _
                "	Description = " & AgL.Chk_Text(TxtName.Text) & ", " & _
                "	Nature = " & AgL.Chk_Text(TxtNature.Text) & " " & _
    ...
    Private Sub FrmQuality1_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        ...
        mQry = "Select Distinct Nature  as Code, Nature as Name, Div_Code " & _
                "  From IE_Doc  " & _
                "  WHERE Nature Is Not Null" & _
                "  Order By Nature"
