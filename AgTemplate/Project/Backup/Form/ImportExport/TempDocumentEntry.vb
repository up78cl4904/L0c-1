...
#End Region
    ...
    Private Sub FrmProductionOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = "UPDATE IE_DocEntry_Log " & _
                " SET " & _
                " Document = " & AgL.Chk_Text(TxtDocumentName.AgSelectedValue) & ", " & _
                " DocumentNo = " & AgL.Chk_Text(TxtDocumentNo.Text) & ", " & _
                " OpenedDate = " & AgL.Chk_Text(TxtOpenedDate.Text) & ", " & _
                " Currency = " & AgL.Chk_Text(TxtCurrency.AgSelectedValue) & ", " & _
                " FileNo = " & AgL.Chk_Text(TxtFileNo.Text) & ", " & _
                " FileDate = " & AgL.Chk_Text(TxtFileDate.Text) & ", " & _
                " Period = " & Val(TxtPeriod.Text) & ", " & _
                " Tollerance = " & Val(TxtTollerance.Text) & ", " & _
                " ImportPayMode = " & AgL.Chk_Text(TxtImpPayMode.Text) & ", " & _
                " ExportPayMode = " & AgL.Chk_Text(TxtExpPayMode.Text) & ", " & _
                " Party = " & AgL.Chk_Text(TxtPartyName.AgSelectedValue) & ", " & _
                " Bank = " & AgL.Chk_Text(TxtBankName.AgSelectedValue) & ", " & _
                " Remark = " & AgL.Chk_Text(TxtRemark.Text) & ", " & _
                " ExpiryDateImport = " & AgL.Chk_Text(TxtImportExpiryDate.Text) & ", " & _
                " ExpiryDateExport = " & AgL.Chk_Text(TxtExportExpiryDate.Text) & " " & _
        ...
        With Dgl1
            For I = 0 To .RowCount - 1
                If .Item(Col1AmendDate, I).Value <> "" Then
                    mSr += 1
                    mQry = "INSERT INTO IE_DocAmend_Log(UID, DocId, Sr, AmendDate, ExpiryDateImport, ExpiryDateExport) " & _
                            " VALUES (" & AgL.Chk_Text(mSearchCode) & ", " & _
                            " " & AgL.Chk_Text(mInternalCode) & ", " & mSr & ", " & _
                            " " & AgL.Chk_Text(.Item(Col1AmendDate, I).Value) & ", " & _
                            " " & AgL.Chk_Text(.Item(Col1ExpiryDateImport, I).Value) & ", " & _
        ...
        With Dgl2
            For I = 0 To .RowCount - 1
                If .Item(Col2Type, I).Value <> "" Then
                    mSr += 1
                    mQry = "INSERT INTO IE_DocItem_Log(UID, DocId, Sr, Type, ItemImportExportGroup, Qty, Unit, " & _
                            " AmountFC, AmountINR) " & _
                            " VALUES (" & AgL.Chk_Text(mSearchCode) & ", " & AgL.Chk_Text(mInternalCode) & ", " & _
                            " " & mSr & ", " & AgL.Chk_Text(.Item(Col2Type, I).Value) & ", " & _
                            " " & AgL.Chk_Text(.Item(Col2ItemImportExportGroup, I).Value) & ", " & _
                            " " & Val(.Item(Col2Qty, I).Value) & ", " & _
                            " " & AgL.Chk_Text(.Item(Col2Unit, I).Value) & ", " & _
                            " " & Val(.Item(Col2AmountFC, I).Value) & ", " & _
    ...
    Private Sub FrmProductionOrder_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        If FrmType = ClsMain.EntryPointType.Main Then
            mQry = "Select P.* " & _
                " From IE_DocEntry P " & _
                " Where P.DocID = '" & SearchCode & "'"
        Else
            mQry = "Select P.* " & _
                " From IE_DocEntry_Log P " & _
    ...
    Private Sub FrmProductionOrder_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        ...
        mQry = " Select Sg.SubCode As Code, Sg.DispName As PartyName From SubGroup Sg " & _
        ...
        mQry = " Select Distinct ItemImportExportGroup As Code, ItemImportExportGroup As Decription " & _
                " From Item I " & _
