Public Class FrmJobQcDetail
    ...
    Public Sub ProcSaveQcParameterDetail(ByVal Conn As SqlClient.SqlConnection, ByVal Cmd As SqlClient.SqlCommand, _
        ...
        With Dgl1
            For J = 0 To .Rows.Count - 1
                If .Item(FrmJobQcDetail.Col1Parameter, J).Value <> "" Then
                    mLineSr += 1
                    mQry = " INSERT INTO QcParameterDetail_Log(DocId, TSr, Sr, Parameter, StdValue, " & _
                            " ActValue, Qty, QcQty, PassedQty, RejectQty, Unit, MeasurePerPcs, " & _
                            " MeasureUnit, TotalMeasure,TotalPassedMeasure, " & _
                            " TotalRejectMeasure, Remarks, UID) " & _
                            " VALUES (" & AgL.Chk_Text(DocId) & ", " & _
                            " " & Val(Sr) & ", " & _
                            " " & Val(mLineSr) & ", " & _
                            " " & AgL.Chk_Text(.Item(Col1Parameter, J).Value) & ", " & _
                            " " & AgL.Chk_Text(.Item(Col1StdValue, J).Value) & ", " & _
                            " " & AgL.Chk_Text(.Item(Col1ActValue, J).Value) & ", " & _
                            " " & Val(.Item(Col1Qty, J).Value) & ", " & _
                            " " & Val(.Item(Col1QcQty, J).Value) & ", " & _
                            " " & Val(.Item(Col1PassedQty, J).Value) & ", " & _
                            " " & Val(.Item(Col1RejectQty, J).Value) & ", " & _
                            " " & AgL.Chk_Text(.Item(Col1Unit, J).Value) & ", " & _
                            " " & Val(.Item(Col1MeasurePerPcs, J).Value) & ", " & _
                            " " & AgL.Chk_Text(.Item(Col1MeasureUnit, J).Value) & ", " & _
                            " " & Val(.Item(Col1TotalMeasure, J).Value) & ", " & _
                            " " & Val(.Item(Col1TotalPassedMeasure, J).Value) & ", " & _
                            " " & Val(.Item(Col1TotalRejectMeasure, J).Value) & ", " & _
                            " " & AgL.Chk_Text(.Item(Col1Remarks, J).Value) & ", " & _
                            " " & AgL.Chk_Text(Uid) & ")"
                    AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
                End If
            Next
    ...
    Public Function FunRetQcParameterDetail(ByVal SearchCode As String, ByVal TSr As Integer, _
        ...
        Try
            If FrmType = ClsMain.EntryPointType.Main Then
                mQry = "Select * from QcParameterDetail  " & _
                    " Where DocId = '" & SearchCode & "' " & _
                    " And TSr = " & Val(TSr) & " " & _
                    " Order By Sr "
            Else
                mQry = "Select * from QcParameterDetail_Log  " & _
