            ...
            For I = 0 To Dgl1.RowCount - 1
                If Dgl1.Item(Col1Item, I).Value <> "" Then
                    ...
                    mQry = "INSERT INTO Stock_Log (UID, DocId, Sr, V_Type, V_Prefix, " & _
                            ...
                            " Item, Process, ToProcess, Godown, Qty_Rec, Unit, " & _
                            " MeasurePerPcs, Measure_Rec, MeasureUnit, Rate, Amount, Status, Cost, RecId) " & _
                            ...
                            " " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1Item, I)) & ", " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1FromProcess, I)) & "," & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1ToProcess, I)) & "," & AgL.Chk_Text(TxtGodown.AgSelectedValue) & ", " & Val(Dgl1.Item(Col1Qty, I).Value) & ", " & AgL.Chk_Text(Dgl1.Item(Col1Unit, I).Value) & "," & _
                            " " & Val(Dgl1.Item(Col1MeasurePerPcs, I).Value) & ", " & Val(Dgl1.Item(Col1TotalMeasure, I).Value) & ", " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1MeasureUnit, I)) & ", " & Val(Dgl1.Item(Col1Rate, I).Value) & ",  " & Val(Dgl1.Item(Col1Amount, I).Value) & ", " & AgL.Chk_Text(Dgl1.Item(Col1Status, I).Value) & ", " & _
            ...
            For I = 0 To Dgl1.RowCount - 1
                If Dgl1.Item(Col1Item, I).Value <> "" Then
                    ...
                    mQry = "INSERT INTO Stock_Log (UID, DocId, Sr, V_Type, V_Prefix, " & _
                            ...
                            " MeasurePerPcs, Measure_Iss, MeasureUnit, Rate, Amount, Status, Cost, RecId) " & _
                            " VALUES (" & AgL.Chk_Text(mSearchCode) & ", " & AgL.Chk_Text(mInternalCode) & ", " & mSr & ", " & AgL.Chk_Text(TxtV_Type.AgSelectedValue) & ", " & AgL.Chk_Text(LblPrefix.Text) & ", " & _
                            " " & AgL.Chk_Text(TxtV_Date.Text) & ", " & Val(TxtV_No.Text) & "," & AgL.Chk_Text(TxtDivision.AgSelectedValue) & ", " & AgL.Chk_Text(TxtSite_Code.AgSelectedValue) & ",  " & AgL.Chk_Text(TxtAcName.AgSelectedValue) & ", " & _
