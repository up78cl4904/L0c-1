...
Public Class FrmVoucherTypeMaster
    ...
    Private Sub FIniMaster(Optional ByVal BytDel As Byte = 0, Optional ByVal BytRefresh As Byte = 1)
        ...
        If AgL.PubMoveRecApplicable Then
            ...
            If Not AgL.StrCmp(AgL.PubUserName, AgLibrary.ClsConstant.PubSuperUserName) Or Not AgL.StrCmp(AgL.PubUserName, "SA") Then
                bCondStr += " And IfNull(Vt.Affect_FA,0) <> 0 "
            End If

            mQry = "Select Vt.V_Type As SearchCode " &
    ...
    Sub Ini_List()
        ...
        mQry = "SELECT Acg.GroupCode as Code, AcG.GroupName as Name  " &
                " FROM AcGroup Acg  " &
        ...
        mQry = "SELECT vpt.V_Prefix as Code, vpt.V_Prefix as Name " &
                " FROM Voucher_Prefix_Type vpt " &
    ...
    Private Sub Topctrl1_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            ...
            AgL.PubFindQry = "Select Vt.V_Type As SearchCode,Vt.V_Type, Vt.Description, vt.Short_Name, Vt.NCat As [Nature Code], vt.Category  " &
                                " From Voucher_Type Vt " & bCondStr
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                ...
                mQry = "INSERT INTO Voucher_Type (NCat,Category,V_Type,Description,Short_Name," &
                        " MnuName, MnuText, MnuAttachedInModule, " &
                        " SystemDefine,DivisionWise,SiteWise,PreparedBy,U_EntDt,U_AE,Number_Method," &
                        " Saperate_Narr,Common_Narr,Narration, ChqNo,ChqDt,ClgDt,Affect_Fa,IsShowVoucherReference) " &
                        " VALUES (" & AgL.Chk_Text(TxtNCat.Text) & "," & AgL.Chk_Text(TxtCategory.Text) & "," &
                        " " & AgL.Chk_Text(TxtV_Type.Text) & "," & AgL.Chk_Text(TxtDescription.Text) & "," &
                        " " & AgL.Chk_Text(TxtShort_Name.Text) & ", " &
                        " " & AgL.Chk_Text(TxtModule.Text) & ", " & AgL.Chk_Text(TxtMenuName.Text) & "," & AgL.Chk_Text(TxtModule.Tag) & ", " &
                        " '" & IIf(mIsSystemDefine, "Y", "N") & "',0," &
                        " " & IIf(AgL.PubSitewiseV_No, 1, 0) & ",'" & AgL.PubUserName & "', " &
                        " '" & AgL.PubLoginDate & "','A'," & AgL.Chk_Text(TxtNumber_Method.Text) & "," &
                        " '" & IIf(AgL.StrCmp(TxtSaperate_Narr.Text, "Yes"), "Y", "N") & "'," &
                        " '" & IIf(AgL.StrCmp(TxtCommon_Narr.Text, "Yes"), "Y", "N") & "'," &
                        " " & AgL.Chk_Text(TxtNarration.Text) & " ," &
                        " '" & IIf(AgL.StrCmp(TxtChqNo.Text, "Yes"), "Y", "N") & "'," &
                        " '" & IIf(AgL.StrCmp(TxtChqDate.Text, "Yes"), "Y", "N") & "'," &
                        " '" & IIf(AgL.StrCmp(TxtClgDt.Text, "Yes"), "Y", "N") & "' ," &
                        " " & IIf(AgL.StrCmp(TxtAffect_FA.Text, "Yes"), 1, 0) & ", " &
            ...
            Else
                ...
                mQry = "UPDATE Voucher_Type  " &
                        ...
                        " Short_Name = " & AgL.Chk_Text(TxtShort_Name.Text) & ", " &
                        " MnuText = " & AgL.Chk_Text(TxtMenuName.Text) & ", " &
                        " MnuName = " & AgL.Chk_Text(TxtModule.Text) & ", " &
                        " MnuAttachedInModule = " & AgL.Chk_Text(TxtModule.Tag) & ", " &
                        " Edit_Date='" & Format(AgL.PubLoginDate, "Short Date") & "', U_AE = 'E'," &
                        " ModifiedBy = '" & AgL.PubUserName & "'," &
                        " Number_Method = " & AgL.Chk_Text(TxtNumber_Method.Text) & "," &
                        " Saperate_Narr = '" & IIf(AgL.StrCmp(TxtSaperate_Narr.Text, "Yes"), "Y", "N") & "', " &
                        " Common_Narr = '" & IIf(AgL.StrCmp(TxtCommon_Narr.Text, "Yes"), "Y", "N") & "', " &
                        " Narration= " & AgL.Chk_Text(TxtNarration.Text) & " ," &
                        " ChqNo = '" & IIf(AgL.StrCmp(TxtChqNo.Text, "Yes"), "Y", "N") & "', " &
                        " ChqDt = '" & IIf(AgL.StrCmp(TxtChqDate.Text, "Yes"), "Y", "N") & "', " &
                        " ClgDt = '" & IIf(AgL.StrCmp(TxtClgDt.Text, "Yes"), "Y", "N") & "', " &
                        " Affect_FA = " & IIf(AgL.StrCmp(TxtAffect_FA.Text, "Yes"), 1, 0) & ", " &
                        " IsShowVoucherReference = " & IIf(AgL.StrCmp(TxtIsShowVoucherReference.Text, "Yes"), 1, 0) & " " &
            ...
            If Topctrl1.Mode = "Edit" Then
                mQry = "DELETE FROM Voucher_Prefix " &
                        " WHERE V_Type = '" & mSearchCode & "' " &
                        " AND Site_Code = '" & AgL.PubSiteCode & "' " &
                        " AND Div_Code = '" & AgL.PubDivCode & "' " &
                        " AND IfNull(Comp_Code,'" & AgL.PubCompCode & "') = '" & AgL.PubCompCode & "' " &
                        " AND (" & AgL.ConvertDate(AgL.PubStartDate) & " BETWEEN Date_From AND Date_To " &
            ...
            DsTemp = AgL.FillData("SELECT S.Code AS Site_Code FROM SiteMast S  ", GcnRead)
                    ...
                    For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                        ...
                        For J = 0 To .Rows.Count - 1
                            If .Item(Col1Prefix, J).Value.ToString <> "" Then
                                mQry = "If Not Exists (Select * from Voucher_Prefix Where V_Type=" & AgL.Chk_Text(TxtV_Type.Text) & " " &
                                        " And Prefix = " & AgL.Chk_Text(.AgSelectedValue(Col1Prefix, J)) & " " &
                                        " And Date_From = " & AgL.Chk_Text(.Item(Col1Date_From, J).Value) & " " &
                                        " And Date_To = " & AgL.Chk_Text(.Item(Col1Date_To, J).Value) & " " &
                                        " And Site_Code = '" & bSite_Code & "' " &
                                        " And Div_Code = '" & AgL.PubDivCode & "' " &
                                        " And IfNull(Comp_Code,'" & AgL.PubCompCode & "') = '" & AgL.PubCompCode & "' " &
                                        " ) " &
                                        " INSERT INTO dbo.Voucher_Prefix( V_Type, Date_From, Prefix, Start_Srl_No, Date_To,  " &
                                        " Site_Code, Div_Code, Comp_Code)  " &
                                        " VALUES (" & AgL.Chk_Text(TxtV_Type.Text) & ", " & AgL.ConvertDate(.Item(Col1Date_From, J).Value.ToString) & "," &
                                        " " & AgL.Chk_Text(.AgSelectedValue(Col1Prefix, J)) & "," & Val(.Item(Col1Start_Srl_No, J).Value) & "," &
                                        " " & AgL.ConvertDate(.Item(Col1Date_To, J).Value.ToString) & ",  " &
            ...
            With DGL2
                For J = 0 To .Rows.Count - 1
                    If .Item(Col2GroupCode, J).Value <> "" Then
                        mQry = " INSERT INTO Voucher_Include ( V_Type, GroupCode, Dr, Cr, SITE_CODE)  " &
                                " VALUES (" & AgL.Chk_Text(TxtV_Type.Text) & "," & AgL.Chk_Text(.AgSelectedValue(Col2GroupCode, J)) & "," &
                                " '" & IIf(.Item(Col2Dr, J).Value, "Y", "N") & "', " &
            ...
            With DGL3
                For J = 0 To .Rows.Count - 1
                    If .Item(Col3GroupCode, J).Value <> "" Then
                        mQry = " INSERT INTO Voucher_Exclude ( V_Type, GroupCode, Dr, Cr, SITE_CODE)  " &
                                " VALUES (" & AgL.Chk_Text(TxtV_Type.Text) & "," & AgL.Chk_Text(.AgSelectedValue(Col3GroupCode, J)) & "," &
                                " '" & IIf(.Item(Col3Dr, J).Value, "Y", "N") & "', " &
        ...
        Try
            ...
            If mSearchCode.ToString.Trim <> "" Then
                ...
                mQry = "SELECT V.* " &
                        ...
                        " WHERE V.V_Type='" & mSearchCode & "' " &
                        " AND V.Site_Code = '" & AgL.PubSiteCode & "' " &
                        " AND IfNull(V.Comp_Code,'" & AgL.PubCompCode & "') = '" & AgL.PubCompCode & "' " &
                        " And (V.Date_From Between " & AgL.ConvertDate(AgL.PubStartDate) & " And " & AgL.ConvertDate(AgL.PubEndDate) & " Or " &
