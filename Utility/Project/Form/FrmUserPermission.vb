    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
                ...
                For I = 0 To .Rows.Count - 1
                    If AgL.XNull(.Item(Col1_MnuName, I).Value).ToString.Trim <> "" Then
                        ...
                        mQry = "Insert Into User_Permission (UserName, MnuModule, MnuName, MnuText, SNo, MnuLevel, Parent," &
                                "  Permission, ReportFor, Active, MainStreamCode) Values(" &
            ...
            mQry = mQry & "SELECT Distinct '" & mSearchCode & "',MnuModule,MnuName,MnuText, " &
                ...
                "Active, Up.MainStreamCode, GroupLevel " &
    ...
    Private Sub Fill_Grid(ByVal UserName As String)
        ...
        Try
            ...
            mQry = "SELECT (Select  MnuText from User_Permission Where MnuName=V.Parent And UserName='SA') as [Parent Name],  V.MnuName As [Menu Name], V.MnuText As [Menu Description], " &
                                " CONVERT(BIT,CASE SUBSTRING(IfNull(U.Permission,''),1,1) WHEN 'A' THEN 1 ELSE 0 END) AS [Add], " &
                                " CONVERT(BIT,CASE SUBSTRING(IfNull(U.Permission,''),2,1) WHEN 'E' THEN 1 ELSE 0 END) AS [Edit], " &
                                " CONVERT(BIT,CASE SUBSTRING(IfNull(U.Permission,''),3,1) WHEN 'D' THEN 1 ELSE 0 END) AS [Delete], " &
                                " CONVERT(BIT,CASE SUBSTRING(IfNull(U.Permission,''),4,1) WHEN 'P' THEN 1 ELSE 0 END) AS [Print], " &
                                ...
                                " ORDER BY V.MainStreamCode Limit 1"
