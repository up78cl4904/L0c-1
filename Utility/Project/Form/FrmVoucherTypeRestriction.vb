...
#End Region
    ...
    Public Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        ...
        AgL.PubFindQry = "SELECT H.Code, H.UserName [User] " &
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = " UPDATE User_Exclude_VType SET " &
                " UserName = " & AgL.Chk_Text(TxtUserName.Text) & ",	" &
        ...
        With Dgl1
            For I = 0 To .RowCount - 1
                If .Item(Col1VoucherType, I).Value <> "" Then
                    mQry = " INSERT INTO User_Exclude_VTypeDetail( Code,	Sr,	UserName, V_Type ) " &
    ...
    Private Sub BtnFill_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnFill.Click
        ...
        Try
            mQry = " SELECT L.* " &
                    " FROM User_Exclude_VType H  " &
                    " LEFT JOIN User_Exclude_VTypeDetail L ON L.Code = H.Code   " &
