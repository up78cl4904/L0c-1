...
Public Class FrmCompanyMaster
    ...
    Private Sub FIniMaster(Optional ByVal BytDel As Byte = 0, Optional ByVal BytRefresh As Byte = 1)
        If AgL.PubMoveRecApplicable Then
            mQry = " SELECT Comp_Code As SearchCode " &
                    " FROM Company C " &
    ...
    Sub Ini_List()
        ...
        mQry = " SELECT Comp_Code AS Code,Comp_Name AS Name " &
                " FROM Company " &
                " ORDER BY Comp_Name "
        TxtCompanyName.AgHelpDataSet = AgL.FillData(mQry, AgL.GCn)

        mQry = " SELECT Comp_Code AS Code,CentralData_Path " &
                " FROM Company "
    ...
    Private Sub Control_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles _
        TxtStartDate.Validating, TxtEndDate.Validating, TxtUseSiteNameAsCompanyName.Validating, TxtComp_Code.Validating, TxtCompanyName.Validating, TxtAdd1.Validating,
        TxtAdd2.Validating, TxtCentralDataPath.Validating, TxtCity.Validating, TxtCountry.Validating, TxtCSTDate.Validating, TxtCSTNo.Validating, TxtCurrentYear.Validating,
        TxtPreviousYear.Validating, TxtPreviousDB.Validating, TxtReportPath.Validating, TxtSerialKeyNo.Validating, TxtSite_Code.Validating, TxtSName.Validating, TxtState.Validating,
    ...
    Private Sub Topctrl1_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            ...
            AgL.PubFindQry = " SELECT C.Comp_Code As SearchCode, C.Comp_Name as [Company Name], C.address1 AS Address1, C.address2 AS Address2, C.city AS City, C.pin AS PIN, C.State, C.phone AS Phone, C.Country " &
                                " FROM Company C " &
                                " Where IfNull(C.DeletedYN,'N') <> 'Y' "
