Public Class FrmVoucherTypeSettings
    ...
    Private Sub FrmVoucher_Type_Print_SettingsMaster_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        Dim mConStr$ = ""
        mConStr = " WHERE 1=1 AND H.Div_Code = '" & AgL.PubDivCode & "' And H.Site_Code = '" & AgL.PubSiteCode & "' AND Isnull(H.IsDeleted,0) = 0"
        AgL.PubFindQry = " SELECT H.Code, H.V_Type, Vt.Description AS [V Type], SM.Name AS SiteName, D.Div_Name " & _
                        " FROM Voucher_Type_Settings H  " & _
    ...
    Private Sub FrmVoucher_Type_Print_SettingsMaster_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = " UPDATE Voucher_Type_Settings " & _
                " SET V_Type = " & AgL.Chk_Text(TxtVoucherType.Tag) & " , " & _
                " IsEditable_SubCode = " & RetBitValue(TxtIsEditableSubCode) & ", " & _
                " IsMandatory_SubCode = " & RetBitValue(TxtIsMandatory_SubCode) & ", " & _
                " IsVisible_MeasurePerPcs = " & RetBitValue(TxtIsVisible_MeasurePerPcs) & ", " & _
                " IsEditable_MeasurePerPcs = " & RetBitValue(TxtIsEditable_MeasurePerPcs) & ", " & _
                " IsVisible_Measure = " & RetBitValue(TxtIsVisible_Measure) & ", " & _
                " IsEditable_Measure = " & RetBitValue(TxtIsEditable_Measure) & ", " & _
                " IsVisible_MeasureUnit = " & RetBitValue(TxtIsVisible_MeasureUnit) & ", " & _
                " IsEditable_MeasureUnit = " & RetBitValue(TxtIsEditable_MeasureUnit) & ", " & _
                " IsVisible_ProdOrder = " & RetBitValue(TxtIsVisible_ProdOrder) & ", " & _
                " IsVisible_Process = " & RetBitValue(TxtIsVisible_Process) & ", " & _
                " IsVisible_LotNo = " & RetBitValue(TxtIsVisible_LotNo) & ", " & _
                " IsVisible_BaleNo = " & RetBitValue(TxtIsVisible_BaleNo) & ", " & _
                " IsPostedInStock = " & RetBitValue(TxtIsPostedInStock) & ", " & _
                " IsPostedInStockProcess = " & RetBitValue(TxtIsPostedInStockProcess) & ", " & _
                " IsVisible_ItemUID = " & RetBitValue(TxtIsVisible_ItemUID) & ", " & _
                " IsVisible_ItemCode = " & RetBitValue(TxtIsVisible_ItemCode) & ", " & _
                " IsEditable_ItemCode = " & RetBitValue(TxtIsEditable_ItemCode) & ", " & _
                " IsEditable_ItemName = " & RetBitValue(TxtIsEditable_ItemName) & ", " & _
                " FilterInclude_Process = '" & RetStringValue(TxtFilterInclude_Process) & "', " & _
                " FilterInclude_AcGroup = '" & RetStringValue(TxtFilterInclude_AcGroup) & "', " & _
                " FilterExclude_AcGroup = '" & RetStringValue(TxtFilterExclude_AcGroup) & "', " & _
                " FilterInclude_ItemType = '" & RetStringValue(TxtFilterInclude_ItemType) & "', " & _
                " FilterInclude_ItemGroup = '" & RetStringValue(TxtFilterInclude_ItemGroup) & "', " & _
                " FilterExclude_ItemGroup = '" & RetStringValue(TxtFilterExclude_ItemGroup) & "', " & _
                " EntryBy = '" & AgL.PubUserName & "', " & _
                " EntryDate = '" & AgL.PubLoginDate & "', " & _
                " ApproveBy =  '" & AgL.PubUserName & "', " & _
                " ApproveDate = '" & AgL.PubLoginDate & "', " & _
                " Site_Code = '" & TxtSiteCode.Tag & "', " & _
                " Div_Code = '" & TxtDivision.Tag & "', " & _
                " FilterInclude_ItemDivision = '" & RetStringValue(TxtFilterInclude_ItemDivision) & "', " & _
                " FilterInclude_ItemSite = '" & RetStringValue(TxtFilterInclude_ItemSite) & "', " & _
                " FilterInclude_SubgroupDivision = '" & RetStringValue(TxtFilterInclude_SubgroupDivision) & "', " & _
                " FilterInclude_SubgroupSite = '" & RetStringValue(TxtFilterInclude_SubgroupSite) & "', " & _
                " FilterExclude_Item = '" & RetStringValue(TxtFilterExclude_Item) & "', " & _
                " FilterInclude_Item = '" & RetStringValue(TxtFilterInclude_Item) & "', " & _
                " IsVisible_ProcessLine =  " & RetBitValue(TxtIsVisible_ProcessLine) & ", " & _
                " IsEditable_ProcessLine =  " & RetBitValue(TxtIsEditable_ProcessLine) & ", " & _
                " DEFAULT_Godown = '" & TxtDEFAULT_Godown.Tag & "', " & _
                " IsVisible_Rate =  " & RetBitValue(TxtIsVisible_Rate) & ", " & _
                " IsEditable_Rate =  " & RetBitValue(TxtIsEditable_Rate) & ", " & _
                " IsVisible_Amount =  " & RetBitValue(TxtIsVisible_Amount) & ", " & _
                " IsEditable_Amount =  " & RetBitValue(TxtIsEditable_Amount) & ", " & _
                " IsMandatory_Rate =  " & RetBitValue(TxtIsMandatory_Rate) & ", " & _
                " FilterExclude_SubGroupDivision = '" & RetStringValue(TxtFilterExclude_SubGroupDivision) & "', " & _
                " FilterExclude_SubGroupSite = '" & RetStringValue(TxtFilterExclude_SubGroupSite) & "', " & _
                " IsVisible_Specification = " & RetBitValue(TxtIsVisible_Specification) & ", " & _
                " IsVisible_BillingType = " & RetBitValue(TxtIsVisible_BillingType) & ", " & _
                " IsVisible_RateType = " & RetBitValue(TxtIsVisible_RateType) & ", " & _
                " FilterInclude_ContraV_Type = '" & RetStringValue(TxtFilterInclude_ContraV_Type) & "', " & _
                " Default_SubCode = '" & TxtDefault_SubCode.Tag & "', " & _
                " FilterInclude_SubGroup = '" & RetStringValue(TxtFilterInclude_SubGroup) & "', " & _
                " IsVisible_Supplier = " & RetBitValue(TxtIsVisible_Supplier) & ", " & _
                " ShowLastPoRates = " & RetBitValue(TxtShowLastPoRates) & ", " & _
                " ShowRecordCount = " & Val(TxtShowRecordCount.Text) & ", " & _
                " IsVisible_PurchQuotation = " & RetBitValue(TxtIsVisible_PurchQuotation) & ", " & _
                " IsVisible_PurchIndent = " & RetBitValue(TxtIsVisible_PurchIndent) & ", " & _
                " IsVisible_FreeQty = " & RetBitValue(TxtIsVisible_FreeQty) & ", " & _
                " IsVisible_MRP = " & RetBitValue(TxtIsVisible_MRP) & ", " & _
                " IsVisible_Deal = " & RetBitValue(TxtIsVisible_Deal) & ", " & _
                " IsVisible_DeliveryDetail = " & RetBitValue(TxtIsVisible_DeliveryDetail) & ", " & _
                " IsVisible_ShippingDetail = " & RetBitValue(TxtIsVisible_ShippingDetail) & ", " & _
                " IsVisible_Qty = " & RetBitValue(TxtIsVisible_Qty) & ", " & _
                " IsVisible_RejQty = " & RetBitValue(TxtIsVisible_RejQty) & ", " & _
                " IsVisible_RejMeasure = " & RetBitValue(TxtIsVisible_RejMeasure) & ", " & _
                " IsVisible_FreeMeasure = " & RetBitValue(TxtIsVisible_FreeMeasure) & ", " & _
                " IsVisible_PartyUPC = " & RetBitValue(TxtIsVisible_PartyUPC) & ", " & _
                " IsVisible_PartySpecification = " & RetBitValue(TxtIsVisible_PartySpecification) & ", " & _
                " IsVisible_Unit = " & RetBitValue(TxtIsVisible_Unit) & ", " & _
                " IsVisible_ProfitMarginPer = " & RetBitValue(TxtIsVisible_ProfitMarginPer) & ", " & _
                " IsVisible_ExpiryDate = " & RetBitValue(TXTIsVisible_ExpiryDate) & ", " & _
                " IsEditable_ProfitMarginPer = " & RetBitValue(TxtIsEditable_ProfitMarginPer) & ", " & _
                " IsVisible_SaleRate = " & RetBitValue(TxtIsVisible_SaleRate) & ", " & _
                " IsPostedInStockVirtual = " & RetBitValue(TxtIsPostedInStockVirtual) & ", " & _
                " IsVisible_PartySKU = " & RetBitValue(TxtIsVisible_PartySKU) & ", " & _
                " IsVisible_CostCenter = " & RetBitValue(TxtIsVisible_CostCenter) & ", " & _
                " IsPostInSaleInvoice = " & RetBitValue(TxtIsPostInSaleInvoice) & ", " & _
                " IsEditable_Qty = " & RetBitValue(TxtIsEditable_Qty) & ", " & _
                " IsMandatory_Approval = " & RetBitValue(TxtIsMandatory_Approval) & ", " & _
                " IndustryType = '" & TxtIndustryType.Text & "', " & _
                " TransactionDelete_AllowedDays = " & Val(TxtTransactionDelete_AllowedDays.Text) & ", " & _
                " TransactionDelete_AllowedDaysAdmin = " & Val(TxtTransactionDelete_AllowedDaysAdmin.Text) & ", " & _
                " TransactionEdit_AllowedDaysAdmin = " & Val(TxtTransactionEdit_AllowedDaysAdmin.Text) & ", " & _
                " TransactionEdit_AllowedDays = " & Val(TxtTransactionEdit_AllowedDays.Text) & ", " & _
                " IsVisible_TransactionHistory = " & RetBitValue(TxtIsVisible_TransactionHistory) & ", " & _
                " TransactionHistory_ColumnWidthCsv = '" & TxtTransactionHistory_ColumnWidthCsv.Text & "', " & _
                " TransactionHistory_SqlQuery = '" & TxtTransactionHistory_SqlQuery.Text & "', " & _
                " FilterExclude_SubGroup = '" & RetStringValue(TxtFilterExclude_Subgroup) & "', " & _
                " IsPostConsumption = " & RetBitValue(TxtIsPostConsumption) & " " & _
    ...
    Private Sub FrmVoucher_Type_Print_SettingsMaster_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        ...
        mQry = "Select Code As SearchCode " & _
            " From Voucher_Type_Settings " & mConStr & _
            " Order By V_Type "
    ...
    Private Sub FrmVoucher_Type_Print_SettingsMaster_BaseFunction_FIniMastLog(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMastLog
        ...
        mQry = "Select UID As SearchCode " & _
               " From Voucher_Type_Settings_log " & mConStr & _
    ...
    Private Sub FrmVoucher_Type_Print_SettingsMaster_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = " SELECT H.* , Vt.Description AS VtDesc, G.Description AS GodownDesc, SG.DispName , SM.Name AS SiteName  " & _
            " FROM Voucher_Type_Settings H " & _
            " LEFT JOIN Voucher_Type Vt ON Vt.V_Type = H.V_Type  " & _
            " LEFT JOIN Godown G ON H.DEFAULT_Godown = G.Code  " & _
            " LEFT JOIN SiteMast SM ON SM.Code = H.Site_Code " & _
            " LEFT JOIN SubGroup SG ON SG.SubCode = H.Default_SubCode  " & _
            ...
            Select Case sender.Name
                ...
                Case TxtDEFAULT_Godown.Name
                    If TxtDEFAULT_Godown.AgHelpDataSet Is Nothing Then
                        mQry = " Select Code, Description FROM Godown " & _
                                " Order By Description "
                ...
                Case TxtSiteCode.Name
                    If TxtSiteCode.AgHelpDataSet Is Nothing Then
                        mQry = " SELECT H.Code, H.Name FROM SiteMast H " & _
                                " Order By H.Name "
            ...
            With DsTemp.Tables(0)
                If .Rows.Count > 0 Then
                    For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                        mQry = " INSERT INTO Voucher_Type_Settings_Log " & _
                        ...
                        mQry = "Select count(*) From Voucher_Type_Settings with (nolock) Where V_Type='" & TxtVoucherType.AgSelectedValue & "' And Div_Code = '" & AgL.PubDivCode & "' And Site_Code = '" & AgL.XNull(.Rows(I)("Code")) & "' "
                        ...
                        mQry = "  Update Voucher_Type_Settings  " & _
                                ...
                                " Where V_TYpe = " & AgL.Chk_Text(TxtVoucherType.Tag) & " AND Div_Code = " & AgL.Chk_Text(AgL.PubDivCode) & " AND Site_Code =" & AgL.Chk_Text(AgL.PubSiteCode) & "  " & _
            ...
            With DsTemp.Tables(0)
                If .Rows.Count > 0 Then
                    For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                        ...
                        mQry = "Select count(*) From Voucher_Type_Settings with (nolock) Where V_Type='" & TxtVoucherType.AgSelectedValue & "' And Site_Code = '" & AgL.PubSiteCode & "' And Div_Code = '" & AgL.XNull(.Rows(I)("Code")) & "' "
                        If AgL.Dman_Execute(mQry, AgL.GcnRead).ExecuteScalar <= 0 Then
                            mQry = " INSERT INTO Voucher_Type_Settings (Code, V_Type , EntryBy , EntryDate, ApproveBy ,ApproveDate, Div_Code, Site_Code ) " & _
                        ...
                        mQry = "  Update Voucher_Type_Settings  " & _
                                ...
                                " SELECT *    " & _
                                " From Voucher_Type_Settings   " & _
                                " Where V_TYpe = " & AgL.Chk_Text(TxtVoucherType.Tag) & " AND Site_Code = " & AgL.Chk_Text(AgL.PubSiteCode) & " AND Div_Code = " & AgL.Chk_Text(AgL.PubDivCode) & "  " & _
                                " ) V1 WHERE V1.V_TYpe = Voucher_Type_Settings.V_Type  " & _
                                " AND V1.Site_Code = Voucher_Type_Settings.Site_Code  " & _
    ...
    Function RetTableColStr(ByVal TableName As String) As String
        ...
        mQry = "DECLARE @ColStr VARCHAR(Max) " & _
                ...
                "AND C.COLUMN_NAME NOT IN ('UID', 'EntryBy', 'EntryDate', 'ApproveBy', 'ApproveDate', 'RowID', 'Site_Code','Div_Code','V_Type','Code', " & _
                " 'Query', 'Report_Name','Report_Heading', 'Report_Format', 'SubReport_QueryList', 'SubReport_NameList') " & _
