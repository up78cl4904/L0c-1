    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                mQry = "Insert Into UserMast (Code, USER_NAME, PASSWD, Description, Admin, UpLoadDate) Values(" & _
            ...
            Else
                mQry = "Update UserMast Set Description=" & AgL.Chk_Text(TxtDescription.Text) & ", PASSWD = " & AgL.Chk_Text(AgL.CODIFY(TxtPassword.Text)) & "," & _
                        " Admin='" & AgL.MidStr(TxtAdminYn.Text, 0, 1) & "', UpLoadDate = " & AgL.ConvertDate(mUploadDate) & " " & _
            ...
            With DGL1
                For I = 0 To .Rows.Count - 1
                    If .Item(Col1CompCode, I).Value <> "" Then
                        mQry = "INSERT INTO UserSite ( User_Name, CompCode, Sitelist, UpLoadDate , DivisionList) VALUES  (" & _
                                " '" & mSearchCode & "', " & AgL.Chk_Text(.AgSelectedValue(Col1CompCode, I)) & "," & _
                                " " & AgL.Chk_Text(.Item(Col1SiteList, I).Value) & ", " & _
                                " " & AgL.ConvertDate(mUploadDate) & ",  " & _
