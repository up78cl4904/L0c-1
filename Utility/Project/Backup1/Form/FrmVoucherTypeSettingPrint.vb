Public Class FrmVoucherTypeSettingsPrint
    ...
    Private Sub FrmVoucher_Type_Print_SettingsMaster_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = " UPDATE Voucher_Type_Settings " & _
                ...
                " Query = '" & TxtQuery.Text & "', " & _
                " Report_Name = '" & TxtReport_Name.Text & "', " & _
                " Report_Format = '" & TxtReport_Format.Text & "', " & _
                " Report_HeadingUnapproved = '" & TxtReport_HeadingUnapproved.Text & "', " & _
                " SubReport_NameList = '" & TxtSubReport_NameList.Text & "', " & _
                " SubReport_QueryList = '" & TxtSubReport_QueryList.Text & "', " & _
                " Report_Heading = '" & TxtReport_Heading.Text & "' " & _
    ...
    Private Sub FrmVoucher_Type_Print_SettingsMaster_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = " SELECT H.* , Vt.Description AS VtDesc, SM.Name AS SiteName  " & _
            " FROM Voucher_Type_Settings H " & _
            " LEFT JOIN Voucher_Type Vt ON Vt.V_Type = H.V_Type  " & _
            " LEFT JOIN SiteMast SM ON SM.Code = H.Site_Code " & _
                ...
                If .Rows.Count > 0 Then
                    For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                        ...
                        If AgL.Dman_Execute(mQry, AgL.GcnRead).ExecuteScalar <= 0 Then
                            mQry = " INSERT INTO Voucher_Type_Settings (Code, V_Type , EntryBy , EntryDate, ApproveBy ,ApproveDate , Site_Code, Div_Code ) " & _
                        ...
                        mQry = "  Update Voucher_Type_Settings  " & _
                                " SET Query = V1.query, " & _
                                " Report_Name = V1.report_name, " & _
                                " Report_Heading = V1.report_heading, " & _
                                " Report_Format = V1.report_format, " & _
                                " Report_HeadingUnapproved = V1.Report_HeadingUnapproved, " & _
                                " SubReport_QueryList = V1.subreport_querylist, " & _
                                " SubReport_NameList = V1.subreport_namelist " & _
                                " FROM " & _
                                " ( " & _
                                " SELECT *    " & _
