Public Class FrmVoucherEntry_TDS
    ...
    Sub IniList()
        Dim mQry$
        mQry = "Select SG.SubCode,SG.Name,IfNull(CT.CityName,''),SG.ManualCode From SubGroup SG Left Join City CT On CT.CityCode=SG.CityCode Where SG.SiteList Like '%|" & AgL.PubSiteCode & "|%' Order by SG.Name"
