...
Public Class FrmAccountMaster
    ...
    Private Sub Topctrl1_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            AgL.PubFindQry = "Select SG.SubCode,SG.[Name],SG.ManualCode,AG.GroupName As GroupUnder,IfNull(SG1.Name,'') As Distributor, " &
                         "(SG.Add1+''+SG.Add2) as Address,IfNull(CityName,'') as City,IfNull(Ctry.Name,'') as Country, " &
                         "ZN.Name AS Zone,SG.Nature,IfNull(CCM.Name,'') As CCenter,SG.TINNo " &
                         "From Subgroup SG " &
                         "Left Join City C On C.CityCode=SG.CityCode  " &
                         "Left Join Country Ctry On Ctry.Code=SG.CountryCode " &
                         "Left Join ZoneMast ZN On ZN.Code=SG.Zone " &
