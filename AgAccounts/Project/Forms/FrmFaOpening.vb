...
Public Class FrmFaOpening
    ...
    Private Sub Topctrl1_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            ...
            AgL.PubFindQry = "Select Lm.DocId As SearchCode, Cast(Lm.V_Date as Date Format 'DD-MMM-YY') As [Voucher Date], " & AgL.V_No_Field("Lm.DocId") & " As [Voucher No.], S.Name As [Site Name] " &
                                    " From LedgerM Lm " &
                                    " Left Join Voucher_Type Vt On Lm.V_Type = Vt.V_Type " &
                                    " Left Join SiteMast S On Lm.Site_Code = S.Code " &
                                    " Where Vt.NCat = " & AgL.Chk_Text(AgLibrary.ClsConstant.NCat_FaOpening) & " And " & AgL.PubSiteCondition("Lm.Site_Code", AgL.PubSiteCode) & " "
