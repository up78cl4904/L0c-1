...
Public Class frmCurrencyMast
    ...
    Public Sub MoveRec()
        ...
        If DTMaster.Rows.Count > 0 Then
            ADTemp = New SqliteDataAdapter("Select Code, Name, Discription, SmallCurrency From Currency " & _
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                ...
                StrDocID = AgL.GetMaxId("Currency", "Code", AgL.GCn, AgL.PubDivCode, AgL.PubSiteCode, 5)
            Else
                StrDocID = Agl.Xnull(DTMaster.Rows(BMBMaster.Position).Item("SearchCode"))
            End If
