...
Public Class FrmBankReconciliation
    ...
    Private Sub FFillGrid()
        ...
        Try
            If UCase(TxtType.Tag) = "C" Then StrCondition = "And IfNull(LG.Clg_Date ,'')<>'' "
            If UCase(TxtType.Tag) = "U" Then StrCondition = "And IfNull(LG.Clg_Date ,'')='' "
