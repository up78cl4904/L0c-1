...
Public Class FrmVoucherEntry_LedgerAdjNew
            ...
            Select Case FGMain.CurrentCell.ColumnIndex
                Case GAdjustmentType
                    If FGMain.AgHelpDataSet(GAdjustmentType) Is Nothing Then
                        If e.KeyCode <> Keys.Enter Then
                            mQry = " Select '" & AdjustmentType_Adjustment & "' As Code, '" & AdjustmentType_Adjustment & "' As Name " &
                                    " UNION ALL " &
    ...
    '    AgL.ADMain = New SqliteDataAdapter("Select DocId, V_SNo, Max(RecId) As RecId, Max(V_Type) As V_Type, " & _
    ...
    Private Sub FHelp_BillNoForReference(ByVal mRow As Integer)
        ...
        AgL.ADMain = New SQLiteDataAdapter("Select DocId, V_SNo, Max(RecId) As RecId, Max(V_Type) As V_Type, " &
                            ...
                            " From ( " &
                            "       Select  LG.DocId,LG.V_SNo,LG.RecId, " &
                            "       LG.V_Type, LG.V_Date, " &
                            ...
                            " Union All " &
                            "       Select	LA.Adj_DocId As DocId,LA.Adj_V_SNo As V_SNo,Null As RecId, " &
