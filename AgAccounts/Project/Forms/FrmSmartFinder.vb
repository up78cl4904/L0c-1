Public Class FrmSmartFinder
    ...
    Private Sub FFillGrid()
        ...
        Else
            StrCondition += " And TBL.V_Type In (Select V_Type From Voucher_Type Where IfNull(AuditAllowed,'N')='Y') "
        End If
    ...
    Private Sub FHP_VoucherType(ByRef e As System.Windows.Forms.KeyPressEventArgs, ByVal Txt As TextBox)
        ...
        StrSQL = "Select 'o' As Tick,V_Type As Code,V_Type As Type,Description,Category From Voucher_Type Where IfNull(AuditAllowed,'N')='Y' Order By Category,V_Type"
    ...
    Private Sub FHP_ChequeNo(ByRef e As System.Windows.Forms.KeyPressEventArgs, ByVal Txt As TextBox)
        ...
        StrSQL = "Select 'o' As Tick,IfNull(LG.Chq_No,'') As Code,IfNull(LG.Chq_No,'') As Chq_No From Ledger_Temp LG Where IfNull(LG.Chq_No,'')<>'' Group By LG.Chq_No Order By LG.Chq_No"
    ...
    Private Sub FHP_Accounts(ByRef e As System.Windows.Forms.KeyPressEventArgs, ByVal Txt As TextBox)
        ...
        StrSQL = "Select 'o' As Tick,SG.SubCode,SG.Name,SG.ManualCode,IfNull(CT.CityName,'') "
