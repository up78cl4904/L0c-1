...
Public Class FrmChequePrinting
    ...
    Private Sub FFillGrid()
        ...
        If UCase(Trim(TxtVNo.Text)) = "ALL" Then
            ...
            StrCondition += "Where (LG1.V_Date Between '" & CDate(TxtFromDate.Text).ToString("u") & "' And '" & CDate(TxtToDate.Text).ToString("u") & "') "
    ...
    Private Sub FHP_VNo(ByRef e As System.Windows.Forms.KeyPressEventArgs, ByVal Txt As TextBox)
        ...
        StrSQL += "(LGT.V_Date Between '" & AgL.RetDate(CDate(TxtFromDate.Text).ToString("u")) & "' And "
