...
Public Class FrmAssetTransaction
    ...
    Public Sub MoveRec()
        ...
        If DTMaster.Rows.Count > 0 Then
            ADTemp = New SqliteDataAdapter("Select AT.V_No,AT.V_No, AT.V_Prefix,AT.V_Date,AT.V_Type,AT.Remark, " & _
    ...
    Private Sub Topctrl1_tbFind() Handles Topctrl1.tbFind
        ...
        Try
            AgL.PubFindQry = "Select AT.DocId,VT.Description,AT.V_No As TransactionId,CAST(AT.V_Date as Date Format 'DD-MMM-YY') As VDate, " &
                    "AG.Name As AssetGroup,AM.Name As Asset " &
                    "From AssetTransaction AT Left Join " &
                    "AssetMast AM On AT.Asset=AM.DocId Left Join " &
                    "AssetGroupMast AG On AM.AssetGroup=AG.Code Left Join " &
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                ...
                TxtRecid.Text = CMain.FGetMaxNo("Select IfNull(Max(Cast(AT.V_No as Integer)),0)+1 As Mx From AssetTransaction AT Where (Case When AT.V_No GLOB '*[0-9]*' Then AT.V_No Else 0 End)<>0 And V_Prefix='" & TxtID.Tag & "' And Site_Code='" & AgL.PubSiteCode & "' And V_Type='" & TxtType.Tag & "' ", AgL.GCn)
            Else
                StrDocID = AgL.XNull(DTMaster.Rows(BMBMaster.Position).Item("SearchCode"))
            End If
            If Trim(Replace(StrDocID, "0", "")) = "" Then MsgBox(" Invalid " & "DocId.") : Exit Sub
            ...
            If Topctrl1.Mode = "Add" Then
                GCnCmd.CommandText = "Insert Into AssetTransaction(DocId,V_Type,V_No,Recid,V_Prefix,V_Date, " &
                                     "Asset,Amount,Remark, " &
        ...
        Select Case sender.Name
            ...
            Case TxtType.Name
                If sender.text <> "" Then
                    ...
                    TxtRecid.Text = CMain.FGetMaxNo("Select IfNull(Max(Cast(AT.V_No as Integer)),0)+1 As Mx From AssetTransaction AT Where (Case When AT.V_No GLOB '*[0-9]*' Then AT.V_No Else 0 End)<>0 And V_Prefix='" & TxtID.Tag & "' And Site_Code='" & AgL.PubSiteCode & "' And V_Type='" & sender.Tag & "' ", AgL.GCn)
                End If
        End Select
    End Sub
