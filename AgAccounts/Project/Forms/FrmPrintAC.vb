...
Public Class FrmPrintAC
    ...
    Private Sub FDocPrint()
        ...
        Try
            ...
            StrQry += "IfNull(SG.ContactPerson,'') As ConPerson,IfNull(SG.Add1,'')+' '+IfNull(SG.Add2,'') AS Address, "
            StrQry += "IfNull(CT.CityName,'') AS CityName,IfNull(C.Name,'') AS Country,IfNull(CCM.Name,'') As CCName, "
            StrQry += "IfNull(SG.PIN,'') AS PinNo,IfNull(SG.Phone,'') AS Phone,IfNull(SG.Mobile,'') AS Mobile,  "
            StrQry += "IfNull(SG.FAX,'') AS Fax,IfNull(SG.TINNo,'') AS TinNo,IfNull(SG.CSTNo,'') AS CSTNo, "
            StrQry += "IfNull(SG.STNo,'') AS STNo,IfNull(SG.EMail,'') AS Email,IfNull(SG.PAN,'') AS PAN, "
            StrQry += "IfNull(SG.DuplicateTIN,'') AS DuplicateTIN,SG.Location,SG.CreditLimit,SG.DueDays, "
            StrQry += "IfNull(TC.Name,'') As TCName,SG.IECCode,SG.ECCCode,SG.Excise,SG.Range,SG.Division, "
    ...
    Private Sub FHP_Party(ByRef e As System.Windows.Forms.KeyPressEventArgs, ByVal Txt As TextBox)
        ...
        StrSQL = "Select 'o' As Tick,SG.SubCode As Code,SG.Name,SG.ManualCode,IfNull(CT.CityName,''),AG.GroupName "
    ...
    Private Sub FHP_Distributor(ByRef e As System.Windows.Forms.KeyPressEventArgs, ByVal Txt As TextBox)
        ...
        StrSQL = "Select 'o' As Tick,SG.SubCode,SG.Name,IfNull(CT.CityName,''),SG.ManualCode From SubGroup SG "
