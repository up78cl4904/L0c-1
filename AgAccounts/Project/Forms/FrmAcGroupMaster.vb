...
Public Class FrmAcGroupMaster
    ...
    Public Sub MoveRec()
        ...
        If DTMaster.Rows.Count > 0 Then
            ADTemp = New SqliteDataAdapter("Select AG.SysGroup,AG.GroupName As Name,AG.GroupUnder,AG.Nature,AG1.GroupName As GrUnderName,AG.GroupNature,AG.ContraGroupName " & _
    ...
    Private Sub FHP_MainNature(ByRef e As System.Windows.Forms.KeyPressEventArgs, ByVal Txt As TextBox)
        ...
        StrSendText = Cmain.FSendText(Txt, e.KeyChar)
        ADTemp = New SqliteDataAdapter(StrSQL, Agl.Gcn)
        ADTemp.Fill(DTMain)
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                ...
                StrDocID = AgL.GetMaxId("AcGroup", "GroupCode", AgL.GCn, AgL.PubDivCode, AgL.PubSiteCode, 5, True)
            Else
                StrDocID = Agl.Xnull(DTMaster.Rows(BMBMaster.Position).Item("SearchCode"))
            End If
            If Trim(Replace(StrDocID, "0", "")) = "" Then MsgBox(" Invalid " & "DocId.") : Exit Sub
