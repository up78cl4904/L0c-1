...
Public Class frmCountryMast
    ...
    Public Sub MoveRec()
        ...
        If DTMaster.Rows.Count > 0 Then
            ADTemp = New SqliteDataAdapter("Select CT.Code, CT.Name,CT.CurrencyCode,CR.Name As Currency " & _
    ...
    Private Sub FHP_CountryName(ByRef e As System.Windows.Forms.KeyPressEventArgs, ByVal Txt As TextBox)
        ...
        Agl.ADMain = New SqliteDataAdapter("Select Code, Name from Currency ", Agl.Gcn)
    ...
    Private Sub Topctrl1_tbSave() Handles Topctrl1.tbSave
        ...
        Try
            ...
            If Topctrl1.Mode = "Add" Then
                ...
                StrDocID = AgL.GetMaxId("Country", "Code", AgL.GCn, AgL.PubDivCode, AgL.PubSiteCode, 5)
            Else
                StrDocID = Agl.Xnull(DTMaster.Rows(BMBMaster.Position).Item("SearchCode"))
            End If
