...
Public Class ClsFunction
    Public Function FOpen(ByVal StrSender As String, ByVal StrSenderText As String)
        ...
        Dim ADMain As SqliteDataAdapter
        ...
        ADMain = New SqliteDataAdapter("Select Permission From User_Permission Where UserName='" & AgL.PubUserName & "' And MnuModule='" & StrModuleName & "' And MnuName='" & StrSender & "'", AgL.GCn)
        ADMain.Fill(DTUP)
        ...
        ADMain = New SqliteDataAdapter("Select GroupText As UP From User_Control_Permission Where UserName='" & AgL.PubUserName & "' And MnuModule='" & StrModuleName & "' And MnuName='" & StrSender & "'", AgL.GCn)
        ADMain.Fill(DTUP)
