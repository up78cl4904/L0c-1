Public Class FrmAccountDetails
    ...
    Sub IniList()
        ...
        mQry = "Select SG.SubCode,SG.Name,IsNull(CT.CityName,''),SG.ManualCode From SubGroup SG Left Join City CT On CT.CityCode=SG.CityCode Where SG.SiteList Like '%|" & AgL.PubSiteCode & "|%' And SG.Nature In ('Agent','Customer','Supplier') Order by SG.Name"
