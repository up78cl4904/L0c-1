...
Module MdlFunction
    ...
    Public Function FGetLedgerBalance(ByVal StrSubCode As String) As Double
        ...
        Try
            DTTemp = CMain.FGetDatTable("Select (IfNull(Sum(LG.AmtDr),0)-IfNull(Sum(LG.AmtCr),0)) As Balance From Ledger LG Where LG.SubCode='" & StrSubCode & "' And LG.Site_Code='" & AgL.PubSiteCode & "' ", AgL.GCn)
    ...
    End Function
    Public Function FGetSinleValue(ByVal StrSQL As String, ByVal SQLCon As SQLiteConnection) As Double
